...
type MutateCustomerRequest struct {
	...
	ResponseContentType enums.ResponseContentTypeEnum_ResponseContentType `protobuf:"varint,6,opt,name=response_content_type,json=responseContentType,proto3,enum=google.ads.googleads.v10.enums.ResponseContentTypeEnum_ResponseContentType" json:"response_content_type,omitempty"`
}

func (x *MutateCustomerRequest) Reset() {
	*x = MutateCustomerRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v10_services_customer_service_proto_msgTypes[0]
...
func (*MutateCustomerRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v10_services_customer_service_proto_rawDescGZIP(), []int{0}
}
...
type CreateCustomerClientRequest struct {
	...
	AccessRole enums.AccessRoleEnum_AccessRole `protobuf:"varint,4,opt,name=access_role,json=accessRole,proto3,enum=google.ads.googleads.v10.enums.AccessRoleEnum_AccessRole" json:"access_role,omitempty"`
	// If true, the request is validated but not executed. Only errors are
	// returned, not results.
...
func (x *CreateCustomerClientRequest) Reset() {
	*x = CreateCustomerClientRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v10_services_customer_service_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*CreateCustomerClientRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v10_services_customer_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *CustomerOperation) Reset() {
	*x = CustomerOperation{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v10_services_customer_service_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*CustomerOperation) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v10_services_customer_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *CreateCustomerClientResponse) Reset() {
	*x = CreateCustomerClientResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v10_services_customer_service_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*CreateCustomerClientResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v10_services_customer_service_proto_rawDescGZIP(), []int{3}
}
...
func (x *MutateCustomerResponse) Reset() {
	*x = MutateCustomerResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v10_services_customer_service_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateCustomerResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v10_services_customer_service_proto_rawDescGZIP(), []int{4}
}
...
func (x *MutateCustomerResult) Reset() {
	*x = MutateCustomerResult{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v10_services_customer_service_proto_msgTypes[5]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateCustomerResult) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v10_services_customer_service_proto_rawDescGZIP(), []int{5}
}
...
func (x *ListAccessibleCustomersRequest) Reset() {
	*x = ListAccessibleCustomersRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v10_services_customer_service_proto_msgTypes[6]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ListAccessibleCustomersRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v10_services_customer_service_proto_rawDescGZIP(), []int{6}
}
...
func (x *ListAccessibleCustomersResponse) Reset() {
	*x = ListAccessibleCustomersResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v10_services_customer_service_proto_msgTypes[7]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ListAccessibleCustomersResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v10_services_customer_service_proto_rawDescGZIP(), []int{7}
}
...
var file_google_ads_googleads_v10_services_customer_service_proto_rawDesc = []byte{
	...
	0x2e, 0x76, 0x31, 0x30, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x1a, 0x30, 0x67,
	...
	0x43, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x65, 0x72, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73,
	0x65, 0x22, 0x2e, 0x82, 0xd3, 0xe4, 0x93, 0x02, 0x28, 0x12, 0x26, 0x2f, 0x76, 0x31, 0x30, 0x2f,
	...
	0x93, 0x02, 0x38, 0x22, 0x33, 0x2f, 0x76, 0x31, 0x30, 0x2f, 0x63, 0x75, 0x73, 0x74, 0x6f, 0x6d,
	...
	0x61, 0x64, 0x73, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x61, 0x64, 0x73, 0x2e, 0x76, 0x31,
	0x30, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x42, 0x14, 0x43, 0x75, 0x73, 0x74,
...
var (
	file_google_ads_googleads_v10_services_customer_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v10_services_customer_service_proto_rawDescData = file_google_ads_googleads_v10_services_customer_service_proto_rawDesc
)

func file_google_ads_googleads_v10_services_customer_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v10_services_customer_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v10_services_customer_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v10_services_customer_service_proto_rawDescData)
	})
	return file_google_ads_googleads_v10_services_customer_service_proto_rawDescData
}

var file_google_ads_googleads_v10_services_customer_service_proto_msgTypes = make([]protoimpl.MessageInfo, 8)
var file_google_ads_googleads_v10_services_customer_service_proto_goTypes = []interface{}{
	(*MutateCustomerRequest)(nil),                          // 0: google.ads.googleads.v10.services.MutateCustomerRequest
	(*CreateCustomerClientRequest)(nil),                    // 1: google.ads.googleads.v10.services.CreateCustomerClientRequest
	(*CustomerOperation)(nil),                              // 2: google.ads.googleads.v10.services.CustomerOperation
	(*CreateCustomerClientResponse)(nil),                   // 3: google.ads.googleads.v10.services.CreateCustomerClientResponse
	(*MutateCustomerResponse)(nil),                         // 4: google.ads.googleads.v10.services.MutateCustomerResponse
	(*MutateCustomerResult)(nil),                           // 5: google.ads.googleads.v10.services.MutateCustomerResult
	(*ListAccessibleCustomersRequest)(nil),                 // 6: google.ads.googleads.v10.services.ListAccessibleCustomersRequest
	(*ListAccessibleCustomersResponse)(nil),                // 7: google.ads.googleads.v10.services.ListAccessibleCustomersResponse
	(enums.ResponseContentTypeEnum_ResponseContentType)(0), // 8: google.ads.googleads.v10.enums.ResponseContentTypeEnum.ResponseContentType
	(*resources.Customer)(nil),                             // 9: google.ads.googleads.v10.resources.Customer
	(enums.AccessRoleEnum_AccessRole)(0),                   // 10: google.ads.googleads.v10.enums.AccessRoleEnum.AccessRole
	(*fieldmaskpb.FieldMask)(nil),                          // 11: google.protobuf.FieldMask
}
var file_google_ads_googleads_v10_services_customer_service_proto_depIdxs = []int32{
	2,  // 0: google.ads.googleads.v10.services.MutateCustomerRequest.operation:type_name -> google.ads.googleads.v10.services.CustomerOperation
	8,  // 1: google.ads.googleads.v10.services.MutateCustomerRequest.response_content_type:type_name -> google.ads.googleads.v10.enums.ResponseContentTypeEnum.ResponseContentType
	9,  // 2: google.ads.googleads.v10.services.CreateCustomerClientRequest.customer_client:type_name -> google.ads.googleads.v10.resources.Customer
	10, // 3: google.ads.googleads.v10.services.CreateCustomerClientRequest.access_role:type_name -> google.ads.googleads.v10.enums.AccessRoleEnum.AccessRole
	9,  // 4: google.ads.googleads.v10.services.CustomerOperation.update:type_name -> google.ads.googleads.v10.resources.Customer
	11, // 5: google.ads.googleads.v10.services.CustomerOperation.update_mask:type_name -> google.protobuf.FieldMask
	5,  // 6: google.ads.googleads.v10.services.MutateCustomerResponse.result:type_name -> google.ads.googleads.v10.services.MutateCustomerResult
	9,  // 7: google.ads.googleads.v10.services.MutateCustomerResult.customer:type_name -> google.ads.googleads.v10.resources.Customer
	0,  // 8: google.ads.googleads.v10.services.CustomerService.MutateCustomer:input_type -> google.ads.googleads.v10.services.MutateCustomerRequest
	6,  // 9: google.ads.googleads.v10.services.CustomerService.ListAccessibleCustomers:input_type -> google.ads.googleads.v10.services.ListAccessibleCustomersRequest
	1,  // 10: google.ads.googleads.v10.services.CustomerService.CreateCustomerClient:input_type -> google.ads.googleads.v10.services.CreateCustomerClientRequest
	4,  // 11: google.ads.googleads.v10.services.CustomerService.MutateCustomer:output_type -> google.ads.googleads.v10.services.MutateCustomerResponse
	7,  // 12: google.ads.googleads.v10.services.CustomerService.ListAccessibleCustomers:output_type -> google.ads.googleads.v10.services.ListAccessibleCustomersResponse
	3,  // 13: google.ads.googleads.v10.services.CustomerService.CreateCustomerClient:output_type -> google.ads.googleads.v10.services.CreateCustomerClientResponse
...
func init() { file_google_ads_googleads_v10_services_customer_service_proto_init() }
func file_google_ads_googleads_v10_services_customer_service_proto_init() {
	if File_google_ads_googleads_v10_services_customer_service_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v10_services_customer_service_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v10_services_customer_service_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v10_services_customer_service_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v10_services_customer_service_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v10_services_customer_service_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v10_services_customer_service_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v10_services_customer_service_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v10_services_customer_service_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
	...
	file_google_ads_googleads_v10_services_customer_service_proto_msgTypes[1].OneofWrappers = []interface{}{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: file_google_ads_googleads_v10_services_customer_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   8,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v10_services_customer_service_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v10_services_customer_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v10_services_customer_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v10_services_customer_service_proto = out.File
	file_google_ads_googleads_v10_services_customer_service_proto_rawDesc = nil
	file_google_ads_googleads_v10_services_customer_service_proto_goTypes = nil
	file_google_ads_googleads_v10_services_customer_service_proto_depIdxs = nil
}
