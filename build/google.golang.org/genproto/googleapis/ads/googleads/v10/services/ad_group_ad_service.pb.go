...
func (x *MutateAdGroupAdsRequest) Reset() {
	*x = MutateAdGroupAdsRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v10_services_ad_group_ad_service_proto_msgTypes[0]
...
func (*MutateAdGroupAdsRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v10_services_ad_group_ad_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *AdGroupAdOperation) Reset() {
	*x = AdGroupAdOperation{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v10_services_ad_group_ad_service_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*AdGroupAdOperation) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v10_services_ad_group_ad_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *MutateAdGroupAdsResponse) Reset() {
	*x = MutateAdGroupAdsResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v10_services_ad_group_ad_service_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateAdGroupAdsResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v10_services_ad_group_ad_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *MutateAdGroupAdResult) Reset() {
	*x = MutateAdGroupAdResult{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v10_services_ad_group_ad_service_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateAdGroupAdResult) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v10_services_ad_group_ad_service_proto_rawDescGZIP(), []int{3}
}
...
var file_google_ads_googleads_v10_services_ad_group_ad_service_proto_rawDesc = []byte{
	...
	0x22, 0x54, 0x82, 0xd3, 0xe4, 0x93, 0x02, 0x35, 0x22, 0x30, 0x2f, 0x76, 0x31, 0x30, 0x2f, 0x63,
...
var (
	file_google_ads_googleads_v10_services_ad_group_ad_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v10_services_ad_group_ad_service_proto_rawDescData = file_google_ads_googleads_v10_services_ad_group_ad_service_proto_rawDesc
)

func file_google_ads_googleads_v10_services_ad_group_ad_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v10_services_ad_group_ad_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v10_services_ad_group_ad_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v10_services_ad_group_ad_service_proto_rawDescData)
	})
	return file_google_ads_googleads_v10_services_ad_group_ad_service_proto_rawDescData
}

var file_google_ads_googleads_v10_services_ad_group_ad_service_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_google_ads_googleads_v10_services_ad_group_ad_service_proto_goTypes = []interface{}{
	(*MutateAdGroupAdsRequest)(nil),                        // 0: google.ads.googleads.v10.services.MutateAdGroupAdsRequest
	(*AdGroupAdOperation)(nil),                             // 1: google.ads.googleads.v10.services.AdGroupAdOperation
	(*MutateAdGroupAdsResponse)(nil),                       // 2: google.ads.googleads.v10.services.MutateAdGroupAdsResponse
	(*MutateAdGroupAdResult)(nil),                          // 3: google.ads.googleads.v10.services.MutateAdGroupAdResult
	...
	(*common.PolicyValidationParameter)(nil),               // 6: google.ads.googleads.v10.common.PolicyValidationParameter
	(*resources.AdGroupAd)(nil),                            // 7: google.ads.googleads.v10.resources.AdGroupAd
	(*status.Status)(nil),                                  // 8: google.rpc.Status
}
var file_google_ads_googleads_v10_services_ad_group_ad_service_proto_depIdxs = []int32{
	1,  // 0: google.ads.googleads.v10.services.MutateAdGroupAdsRequest.operations:type_name -> google.ads.googleads.v10.services.AdGroupAdOperation
	4,  // 1: google.ads.googleads.v10.services.MutateAdGroupAdsRequest.response_content_type:type_name -> google.ads.googleads.v10.enums.ResponseContentTypeEnum.ResponseContentType
	5,  // 2: google.ads.googleads.v10.services.AdGroupAdOperation.update_mask:type_name -> google.protobuf.FieldMask
	6,  // 3: google.ads.googleads.v10.services.AdGroupAdOperation.policy_validation_parameter:type_name -> google.ads.googleads.v10.common.PolicyValidationParameter
	7,  // 4: google.ads.googleads.v10.services.AdGroupAdOperation.create:type_name -> google.ads.googleads.v10.resources.AdGroupAd
	7,  // 5: google.ads.googleads.v10.services.AdGroupAdOperation.update:type_name -> google.ads.googleads.v10.resources.AdGroupAd
	8,  // 6: google.ads.googleads.v10.services.MutateAdGroupAdsResponse.partial_failure_error:type_name -> google.rpc.Status
	3,  // 7: google.ads.googleads.v10.services.MutateAdGroupAdsResponse.results:type_name -> google.ads.googleads.v10.services.MutateAdGroupAdResult
	7,  // 8: google.ads.googleads.v10.services.MutateAdGroupAdResult.ad_group_ad:type_name -> google.ads.googleads.v10.resources.AdGroupAd
	0,  // 9: google.ads.googleads.v10.services.AdGroupAdService.MutateAdGroupAds:input_type -> google.ads.googleads.v10.services.MutateAdGroupAdsRequest
	2,  // 10: google.ads.googleads.v10.services.AdGroupAdService.MutateAdGroupAds:output_type -> google.ads.googleads.v10.services.MutateAdGroupAdsResponse
...
func init() { file_google_ads_googleads_v10_services_ad_group_ad_service_proto_init() }
func file_google_ads_googleads_v10_services_ad_group_ad_service_proto_init() {
	if File_google_ads_googleads_v10_services_ad_group_ad_service_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v10_services_ad_group_ad_service_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v10_services_ad_group_ad_service_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v10_services_ad_group_ad_service_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v10_services_ad_group_ad_service_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
	...
	file_google_ads_googleads_v10_services_ad_group_ad_service_proto_msgTypes[1].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v10_services_ad_group_ad_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v10_services_ad_group_ad_service_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v10_services_ad_group_ad_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v10_services_ad_group_ad_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v10_services_ad_group_ad_service_proto = out.File
	file_google_ads_googleads_v10_services_ad_group_ad_service_proto_rawDesc = nil
	file_google_ads_googleads_v10_services_ad_group_ad_service_proto_goTypes = nil
	file_google_ads_googleads_v10_services_ad_group_ad_service_proto_depIdxs = nil
}
...
func (c *adGroupAdServiceClient) MutateAdGroupAds(ctx context.Context, in *MutateAdGroupAdsRequest, opts ...grpc.CallOption) (*MutateAdGroupAdsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/google.ads.googleads.v10.services.AdGroupAdService/MutateAdGroupAds", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _AdGroupAdService_MutateAdGroupAds_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/google.ads.googleads.v10.services.AdGroupAdService/MutateAdGroupAds",
	}
