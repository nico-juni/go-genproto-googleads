...
type MutateAssetsRequest struct {
	...
	ResponseContentType enums.ResponseContentTypeEnum_ResponseContentType `protobuf:"varint,3,opt,name=response_content_type,json=responseContentType,proto3,enum=google.ads.googleads.v10.enums.ResponseContentTypeEnum_ResponseContentType" json:"response_content_type,omitempty"`
...
func (x *MutateAssetsRequest) Reset() {
	*x = MutateAssetsRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v10_services_asset_service_proto_msgTypes[0]
...
func (*MutateAssetsRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v10_services_asset_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *AssetOperation) Reset() {
	*x = AssetOperation{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v10_services_asset_service_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*AssetOperation) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v10_services_asset_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *MutateAssetsResponse) Reset() {
	*x = MutateAssetsResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v10_services_asset_service_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateAssetsResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v10_services_asset_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *MutateAssetResult) Reset() {
	*x = MutateAssetResult{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v10_services_asset_service_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateAssetResult) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v10_services_asset_service_proto_rawDescGZIP(), []int{3}
}
...
var file_google_ads_googleads_v10_services_asset_service_proto_rawDesc = []byte{
...
var (
	file_google_ads_googleads_v10_services_asset_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v10_services_asset_service_proto_rawDescData = file_google_ads_googleads_v10_services_asset_service_proto_rawDesc
)

func file_google_ads_googleads_v10_services_asset_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v10_services_asset_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v10_services_asset_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v10_services_asset_service_proto_rawDescData)
	})
	return file_google_ads_googleads_v10_services_asset_service_proto_rawDescData
}

var file_google_ads_googleads_v10_services_asset_service_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_google_ads_googleads_v10_services_asset_service_proto_goTypes = []interface{}{
	(*MutateAssetsRequest)(nil),                            // 0: google.ads.googleads.v10.services.MutateAssetsRequest
	(*AssetOperation)(nil),                                 // 1: google.ads.googleads.v10.services.AssetOperation
	(*MutateAssetsResponse)(nil),                           // 2: google.ads.googleads.v10.services.MutateAssetsResponse
	(*MutateAssetResult)(nil),                              // 3: google.ads.googleads.v10.services.MutateAssetResult
	...
	(*resources.Asset)(nil),                                // 6: google.ads.googleads.v10.resources.Asset
	(*status.Status)(nil),                                  // 7: google.rpc.Status
}
var file_google_ads_googleads_v10_services_asset_service_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v10.services.MutateAssetsRequest.operations:type_name -> google.ads.googleads.v10.services.AssetOperation
	4, // 1: google.ads.googleads.v10.services.MutateAssetsRequest.response_content_type:type_name -> google.ads.googleads.v10.enums.ResponseContentTypeEnum.ResponseContentType
	5, // 2: google.ads.googleads.v10.services.AssetOperation.update_mask:type_name -> google.protobuf.FieldMask
	6, // 3: google.ads.googleads.v10.services.AssetOperation.create:type_name -> google.ads.googleads.v10.resources.Asset
	6, // 4: google.ads.googleads.v10.services.AssetOperation.update:type_name -> google.ads.googleads.v10.resources.Asset
	7, // 5: google.ads.googleads.v10.services.MutateAssetsResponse.partial_failure_error:type_name -> google.rpc.Status
	3, // 6: google.ads.googleads.v10.services.MutateAssetsResponse.results:type_name -> google.ads.googleads.v10.services.MutateAssetResult
	6, // 7: google.ads.googleads.v10.services.MutateAssetResult.asset:type_name -> google.ads.googleads.v10.resources.Asset
	0, // 8: google.ads.googleads.v10.services.AssetService.MutateAssets:input_type -> google.ads.googleads.v10.services.MutateAssetsRequest
	2, // 9: google.ads.googleads.v10.services.AssetService.MutateAssets:output_type -> google.ads.googleads.v10.services.MutateAssetsResponse
...
func init() { file_google_ads_googleads_v10_services_asset_service_proto_init() }
func file_google_ads_googleads_v10_services_asset_service_proto_init() {
	if File_google_ads_googleads_v10_services_asset_service_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v10_services_asset_service_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v10_services_asset_service_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v10_services_asset_service_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v10_services_asset_service_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
	...
	file_google_ads_googleads_v10_services_asset_service_proto_msgTypes[1].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v10_services_asset_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v10_services_asset_service_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v10_services_asset_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v10_services_asset_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v10_services_asset_service_proto = out.File
	file_google_ads_googleads_v10_services_asset_service_proto_rawDesc = nil
	file_google_ads_googleads_v10_services_asset_service_proto_goTypes = nil
	file_google_ads_googleads_v10_services_asset_service_proto_depIdxs = nil
}
