...
// internalAssetGroupSignalClient is an interface that defines the methods availaible from Google Ads API.
...
func (c *assetGroupSignalGRPCClient) MutateAssetGroupSignals(ctx context.Context, req *servicespb.MutateAssetGroupSignalsRequest, opts ...gax.CallOption) (*servicespb.MutateAssetGroupSignalsResponse, error) {
	...
	err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		var err error
		resp, err = c.assetGroupSignalClient.MutateAssetGroupSignals(ctx, req, settings.GRPC...)
		return err
	}, opts...)
	if err != nil {
		return nil, err
