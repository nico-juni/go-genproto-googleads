...
func (x *MutateAdGroupAdLabelsRequest) Reset() {
	*x = MutateAdGroupAdLabelsRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v10_services_ad_group_ad_label_service_proto_msgTypes[0]
...
func (*MutateAdGroupAdLabelsRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v10_services_ad_group_ad_label_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *AdGroupAdLabelOperation) Reset() {
	*x = AdGroupAdLabelOperation{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v10_services_ad_group_ad_label_service_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*AdGroupAdLabelOperation) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v10_services_ad_group_ad_label_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *MutateAdGroupAdLabelsResponse) Reset() {
	*x = MutateAdGroupAdLabelsResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v10_services_ad_group_ad_label_service_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateAdGroupAdLabelsResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v10_services_ad_group_ad_label_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *MutateAdGroupAdLabelResult) Reset() {
	*x = MutateAdGroupAdLabelResult{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v10_services_ad_group_ad_label_service_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateAdGroupAdLabelResult) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v10_services_ad_group_ad_label_service_proto_rawDescGZIP(), []int{3}
}
...
var file_google_ads_googleads_v10_services_ad_group_ad_label_service_proto_rawDesc = []byte{
	...
	0x30, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x42, 0x1a, 0x41, 0x64, 0x47, 0x72,
	0x6f, 0x75, 0x70, 0x41, 0x64, 0x4c, 0x61, 0x62, 0x65, 0x6c, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63,
...
var (
	file_google_ads_googleads_v10_services_ad_group_ad_label_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v10_services_ad_group_ad_label_service_proto_rawDescData = file_google_ads_googleads_v10_services_ad_group_ad_label_service_proto_rawDesc
)

func file_google_ads_googleads_v10_services_ad_group_ad_label_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v10_services_ad_group_ad_label_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v10_services_ad_group_ad_label_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v10_services_ad_group_ad_label_service_proto_rawDescData)
	})
	return file_google_ads_googleads_v10_services_ad_group_ad_label_service_proto_rawDescData
}

var file_google_ads_googleads_v10_services_ad_group_ad_label_service_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_google_ads_googleads_v10_services_ad_group_ad_label_service_proto_goTypes = []interface{}{
	(*MutateAdGroupAdLabelsRequest)(nil),  // 0: google.ads.googleads.v10.services.MutateAdGroupAdLabelsRequest
	(*AdGroupAdLabelOperation)(nil),       // 1: google.ads.googleads.v10.services.AdGroupAdLabelOperation
	(*MutateAdGroupAdLabelsResponse)(nil), // 2: google.ads.googleads.v10.services.MutateAdGroupAdLabelsResponse
	(*MutateAdGroupAdLabelResult)(nil),    // 3: google.ads.googleads.v10.services.MutateAdGroupAdLabelResult
	(*resources.AdGroupAdLabel)(nil),      // 4: google.ads.googleads.v10.resources.AdGroupAdLabel
	(*status.Status)(nil),                 // 5: google.rpc.Status
}
var file_google_ads_googleads_v10_services_ad_group_ad_label_service_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v10.services.MutateAdGroupAdLabelsRequest.operations:type_name -> google.ads.googleads.v10.services.AdGroupAdLabelOperation
	4, // 1: google.ads.googleads.v10.services.AdGroupAdLabelOperation.create:type_name -> google.ads.googleads.v10.resources.AdGroupAdLabel
	5, // 2: google.ads.googleads.v10.services.MutateAdGroupAdLabelsResponse.partial_failure_error:type_name -> google.rpc.Status
	3, // 3: google.ads.googleads.v10.services.MutateAdGroupAdLabelsResponse.results:type_name -> google.ads.googleads.v10.services.MutateAdGroupAdLabelResult
	0, // 4: google.ads.googleads.v10.services.AdGroupAdLabelService.MutateAdGroupAdLabels:input_type -> google.ads.googleads.v10.services.MutateAdGroupAdLabelsRequest
	2, // 5: google.ads.googleads.v10.services.AdGroupAdLabelService.MutateAdGroupAdLabels:output_type -> google.ads.googleads.v10.services.MutateAdGroupAdLabelsResponse
...
func init() { file_google_ads_googleads_v10_services_ad_group_ad_label_service_proto_init() }
func file_google_ads_googleads_v10_services_ad_group_ad_label_service_proto_init() {
	if File_google_ads_googleads_v10_services_ad_group_ad_label_service_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v10_services_ad_group_ad_label_service_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v10_services_ad_group_ad_label_service_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v10_services_ad_group_ad_label_service_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v10_services_ad_group_ad_label_service_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
	...
	file_google_ads_googleads_v10_services_ad_group_ad_label_service_proto_msgTypes[1].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v10_services_ad_group_ad_label_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v10_services_ad_group_ad_label_service_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v10_services_ad_group_ad_label_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v10_services_ad_group_ad_label_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v10_services_ad_group_ad_label_service_proto = out.File
	file_google_ads_googleads_v10_services_ad_group_ad_label_service_proto_rawDesc = nil
	file_google_ads_googleads_v10_services_ad_group_ad_label_service_proto_goTypes = nil
	file_google_ads_googleads_v10_services_ad_group_ad_label_service_proto_depIdxs = nil
}
...
func (c *adGroupAdLabelServiceClient) MutateAdGroupAdLabels(ctx context.Context, in *MutateAdGroupAdLabelsRequest, opts ...grpc.CallOption) (*MutateAdGroupAdLabelsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/google.ads.googleads.v10.services.AdGroupAdLabelService/MutateAdGroupAdLabels", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _AdGroupAdLabelService_MutateAdGroupAdLabels_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/google.ads.googleads.v10.services.AdGroupAdLabelService/MutateAdGroupAdLabels",
	}
