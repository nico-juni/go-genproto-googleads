...
func (x *Customer) Reset() {
	*x = Customer{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v9_resources_customer_proto_msgTypes[0]
...
func (*Customer) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v9_resources_customer_proto_rawDescGZIP(), []int{0}
}
...
func (x *CallReportingSetting) Reset() {
	*x = CallReportingSetting{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v9_resources_customer_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*CallReportingSetting) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v9_resources_customer_proto_rawDescGZIP(), []int{1}
}
...
func (x *ConversionTrackingSetting) Reset() {
	*x = ConversionTrackingSetting{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v9_resources_customer_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ConversionTrackingSetting) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v9_resources_customer_proto_rawDescGZIP(), []int{2}
}
...
func (x *RemarketingSetting) Reset() {
	*x = RemarketingSetting{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v9_resources_customer_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*RemarketingSetting) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v9_resources_customer_proto_rawDescGZIP(), []int{3}
}
...
var File_google_ads_googleads_v9_resources_customer_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v9_resources_customer_proto_rawDesc = []byte{
...
var (
	file_google_ads_googleads_v9_resources_customer_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v9_resources_customer_proto_rawDescData = file_google_ads_googleads_v9_resources_customer_proto_rawDesc
)

func file_google_ads_googleads_v9_resources_customer_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v9_resources_customer_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v9_resources_customer_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v9_resources_customer_proto_rawDescData)
	})
	return file_google_ads_googleads_v9_resources_customer_proto_rawDescData
}

var file_google_ads_googleads_v9_resources_customer_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_google_ads_googleads_v9_resources_customer_proto_goTypes = []interface{}{
...
var file_google_ads_googleads_v9_resources_customer_proto_depIdxs = []int32{
...
func init() { file_google_ads_googleads_v9_resources_customer_proto_init() }
func file_google_ads_googleads_v9_resources_customer_proto_init() {
	if File_google_ads_googleads_v9_resources_customer_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v9_resources_customer_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v9_resources_customer_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v9_resources_customer_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v9_resources_customer_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
	...
	file_google_ads_googleads_v9_resources_customer_proto_msgTypes[0].OneofWrappers = []interface{}{}
	file_google_ads_googleads_v9_resources_customer_proto_msgTypes[1].OneofWrappers = []interface{}{}
	file_google_ads_googleads_v9_resources_customer_proto_msgTypes[2].OneofWrappers = []interface{}{}
	file_google_ads_googleads_v9_resources_customer_proto_msgTypes[3].OneofWrappers = []interface{}{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: file_google_ads_googleads_v9_resources_customer_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_google_ads_googleads_v9_resources_customer_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v9_resources_customer_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v9_resources_customer_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v9_resources_customer_proto = out.File
	file_google_ads_googleads_v9_resources_customer_proto_rawDesc = nil
	file_google_ads_googleads_v9_resources_customer_proto_goTypes = nil
	file_google_ads_googleads_v9_resources_customer_proto_depIdxs = nil
}
