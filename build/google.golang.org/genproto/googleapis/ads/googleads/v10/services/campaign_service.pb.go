...
func (x *MutateCampaignsRequest) Reset() {
	*x = MutateCampaignsRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v10_services_campaign_service_proto_msgTypes[0]
...
func (*MutateCampaignsRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v10_services_campaign_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *CampaignOperation) Reset() {
	*x = CampaignOperation{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v10_services_campaign_service_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*CampaignOperation) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v10_services_campaign_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *MutateCampaignsResponse) Reset() {
	*x = MutateCampaignsResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v10_services_campaign_service_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateCampaignsResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v10_services_campaign_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *MutateCampaignResult) Reset() {
	*x = MutateCampaignResult{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v10_services_campaign_service_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateCampaignResult) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v10_services_campaign_service_proto_rawDescGZIP(), []int{3}
}
...
var file_google_ads_googleads_v10_services_campaign_service_proto_rawDesc = []byte{
	...
	0x2e, 0x76, 0x31, 0x30, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x1a, 0x3a, 0x67,
	...
	0xd3, 0xe4, 0x93, 0x02, 0x34, 0x22, 0x2f, 0x2f, 0x76, 0x31, 0x30, 0x2f, 0x63, 0x75, 0x73, 0x74,
...
var (
	file_google_ads_googleads_v10_services_campaign_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v10_services_campaign_service_proto_rawDescData = file_google_ads_googleads_v10_services_campaign_service_proto_rawDesc
)

func file_google_ads_googleads_v10_services_campaign_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v10_services_campaign_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v10_services_campaign_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v10_services_campaign_service_proto_rawDescData)
	})
	return file_google_ads_googleads_v10_services_campaign_service_proto_rawDescData
}

var file_google_ads_googleads_v10_services_campaign_service_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_google_ads_googleads_v10_services_campaign_service_proto_goTypes = []interface{}{
	(*MutateCampaignsRequest)(nil),                         // 0: google.ads.googleads.v10.services.MutateCampaignsRequest
	(*CampaignOperation)(nil),                              // 1: google.ads.googleads.v10.services.CampaignOperation
	(*MutateCampaignsResponse)(nil),                        // 2: google.ads.googleads.v10.services.MutateCampaignsResponse
	(*MutateCampaignResult)(nil),                           // 3: google.ads.googleads.v10.services.MutateCampaignResult
	...
	(*resources.Campaign)(nil),                             // 6: google.ads.googleads.v10.resources.Campaign
	(*status.Status)(nil),                                  // 7: google.rpc.Status
}
var file_google_ads_googleads_v10_services_campaign_service_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v10.services.MutateCampaignsRequest.operations:type_name -> google.ads.googleads.v10.services.CampaignOperation
	4, // 1: google.ads.googleads.v10.services.MutateCampaignsRequest.response_content_type:type_name -> google.ads.googleads.v10.enums.ResponseContentTypeEnum.ResponseContentType
	5, // 2: google.ads.googleads.v10.services.CampaignOperation.update_mask:type_name -> google.protobuf.FieldMask
	6, // 3: google.ads.googleads.v10.services.CampaignOperation.create:type_name -> google.ads.googleads.v10.resources.Campaign
	6, // 4: google.ads.googleads.v10.services.CampaignOperation.update:type_name -> google.ads.googleads.v10.resources.Campaign
	7, // 5: google.ads.googleads.v10.services.MutateCampaignsResponse.partial_failure_error:type_name -> google.rpc.Status
	3, // 6: google.ads.googleads.v10.services.MutateCampaignsResponse.results:type_name -> google.ads.googleads.v10.services.MutateCampaignResult
	6, // 7: google.ads.googleads.v10.services.MutateCampaignResult.campaign:type_name -> google.ads.googleads.v10.resources.Campaign
	0, // 8: google.ads.googleads.v10.services.CampaignService.MutateCampaigns:input_type -> google.ads.googleads.v10.services.MutateCampaignsRequest
	2, // 9: google.ads.googleads.v10.services.CampaignService.MutateCampaigns:output_type -> google.ads.googleads.v10.services.MutateCampaignsResponse
...
func init() { file_google_ads_googleads_v10_services_campaign_service_proto_init() }
func file_google_ads_googleads_v10_services_campaign_service_proto_init() {
	if File_google_ads_googleads_v10_services_campaign_service_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v10_services_campaign_service_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v10_services_campaign_service_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v10_services_campaign_service_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v10_services_campaign_service_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
	...
	file_google_ads_googleads_v10_services_campaign_service_proto_msgTypes[1].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v10_services_campaign_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v10_services_campaign_service_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v10_services_campaign_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v10_services_campaign_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v10_services_campaign_service_proto = out.File
	file_google_ads_googleads_v10_services_campaign_service_proto_rawDesc = nil
	file_google_ads_googleads_v10_services_campaign_service_proto_goTypes = nil
	file_google_ads_googleads_v10_services_campaign_service_proto_depIdxs = nil
}
