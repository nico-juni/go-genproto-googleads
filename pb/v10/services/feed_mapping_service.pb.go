...
func (x *MutateFeedMappingsRequest) Reset() {
	*x = MutateFeedMappingsRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v10_services_feed_mapping_service_proto_msgTypes[0]
...
func (*MutateFeedMappingsRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v10_services_feed_mapping_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *FeedMappingOperation) Reset() {
	*x = FeedMappingOperation{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v10_services_feed_mapping_service_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*FeedMappingOperation) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v10_services_feed_mapping_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *MutateFeedMappingsResponse) Reset() {
	*x = MutateFeedMappingsResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v10_services_feed_mapping_service_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateFeedMappingsResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v10_services_feed_mapping_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *MutateFeedMappingResult) Reset() {
	*x = MutateFeedMappingResult{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v10_services_feed_mapping_service_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateFeedMappingResult) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v10_services_feed_mapping_service_proto_rawDescGZIP(), []int{3}
}
...
var file_google_ads_googleads_v10_services_feed_mapping_service_proto_rawDesc = []byte{
	...
	0x76, 0x31, 0x30, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x2e, 0x46, 0x65, 0x65,
	...
	0x30, 0x2e, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x2e, 0x46, 0x65, 0x65, 0x64,
...
var (
	file_google_ads_googleads_v10_services_feed_mapping_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v10_services_feed_mapping_service_proto_rawDescData = file_google_ads_googleads_v10_services_feed_mapping_service_proto_rawDesc
)

func file_google_ads_googleads_v10_services_feed_mapping_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v10_services_feed_mapping_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v10_services_feed_mapping_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v10_services_feed_mapping_service_proto_rawDescData)
	})
	return file_google_ads_googleads_v10_services_feed_mapping_service_proto_rawDescData
}

var file_google_ads_googleads_v10_services_feed_mapping_service_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_google_ads_googleads_v10_services_feed_mapping_service_proto_goTypes = []interface{}{
	(*MutateFeedMappingsRequest)(nil),                      // 0: google.ads.googleads.v10.services.MutateFeedMappingsRequest
	(*FeedMappingOperation)(nil),                           // 1: google.ads.googleads.v10.services.FeedMappingOperation
	(*MutateFeedMappingsResponse)(nil),                     // 2: google.ads.googleads.v10.services.MutateFeedMappingsResponse
	(*MutateFeedMappingResult)(nil),                        // 3: google.ads.googleads.v10.services.MutateFeedMappingResult
	...
	(*resources.FeedMapping)(nil),                          // 5: google.ads.googleads.v10.resources.FeedMapping
	(*status.Status)(nil),                                  // 6: google.rpc.Status
}
var file_google_ads_googleads_v10_services_feed_mapping_service_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v10.services.MutateFeedMappingsRequest.operations:type_name -> google.ads.googleads.v10.services.FeedMappingOperation
	4, // 1: google.ads.googleads.v10.services.MutateFeedMappingsRequest.response_content_type:type_name -> google.ads.googleads.v10.enums.ResponseContentTypeEnum.ResponseContentType
	5, // 2: google.ads.googleads.v10.services.FeedMappingOperation.create:type_name -> google.ads.googleads.v10.resources.FeedMapping
	6, // 3: google.ads.googleads.v10.services.MutateFeedMappingsResponse.partial_failure_error:type_name -> google.rpc.Status
	3, // 4: google.ads.googleads.v10.services.MutateFeedMappingsResponse.results:type_name -> google.ads.googleads.v10.services.MutateFeedMappingResult
	5, // 5: google.ads.googleads.v10.services.MutateFeedMappingResult.feed_mapping:type_name -> google.ads.googleads.v10.resources.FeedMapping
	0, // 6: google.ads.googleads.v10.services.FeedMappingService.MutateFeedMappings:input_type -> google.ads.googleads.v10.services.MutateFeedMappingsRequest
	2, // 7: google.ads.googleads.v10.services.FeedMappingService.MutateFeedMappings:output_type -> google.ads.googleads.v10.services.MutateFeedMappingsResponse
...
func init() { file_google_ads_googleads_v10_services_feed_mapping_service_proto_init() }
func file_google_ads_googleads_v10_services_feed_mapping_service_proto_init() {
	if File_google_ads_googleads_v10_services_feed_mapping_service_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v10_services_feed_mapping_service_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v10_services_feed_mapping_service_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v10_services_feed_mapping_service_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v10_services_feed_mapping_service_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
	...
	file_google_ads_googleads_v10_services_feed_mapping_service_proto_msgTypes[1].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v10_services_feed_mapping_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v10_services_feed_mapping_service_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v10_services_feed_mapping_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v10_services_feed_mapping_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v10_services_feed_mapping_service_proto = out.File
	file_google_ads_googleads_v10_services_feed_mapping_service_proto_rawDesc = nil
	file_google_ads_googleads_v10_services_feed_mapping_service_proto_goTypes = nil
	file_google_ads_googleads_v10_services_feed_mapping_service_proto_depIdxs = nil
}
