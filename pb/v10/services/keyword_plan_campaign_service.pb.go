...
func (x *MutateKeywordPlanCampaignsRequest) Reset() {
	*x = MutateKeywordPlanCampaignsRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v10_services_keyword_plan_campaign_service_proto_msgTypes[0]
...
func (*MutateKeywordPlanCampaignsRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v10_services_keyword_plan_campaign_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *KeywordPlanCampaignOperation) Reset() {
	*x = KeywordPlanCampaignOperation{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v10_services_keyword_plan_campaign_service_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*KeywordPlanCampaignOperation) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v10_services_keyword_plan_campaign_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *MutateKeywordPlanCampaignsResponse) Reset() {
	*x = MutateKeywordPlanCampaignsResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v10_services_keyword_plan_campaign_service_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateKeywordPlanCampaignsResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v10_services_keyword_plan_campaign_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *MutateKeywordPlanCampaignResult) Reset() {
	*x = MutateKeywordPlanCampaignResult{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v10_services_keyword_plan_campaign_service_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateKeywordPlanCampaignResult) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v10_services_keyword_plan_campaign_service_proto_rawDescGZIP(), []int{3}
}
...
var file_google_ads_googleads_v10_services_keyword_plan_campaign_service_proto_rawDesc = []byte{
	...
	0x76, 0x31, 0x30, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x2e, 0x4b, 0x65, 0x79,
	...
	0x61, 0x64, 0x73, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x61, 0x64, 0x73, 0x2e, 0x76, 0x31,
	0x30, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x42, 0x1f, 0x4b, 0x65, 0x79, 0x77,
...
var (
	file_google_ads_googleads_v10_services_keyword_plan_campaign_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v10_services_keyword_plan_campaign_service_proto_rawDescData = file_google_ads_googleads_v10_services_keyword_plan_campaign_service_proto_rawDesc
)

func file_google_ads_googleads_v10_services_keyword_plan_campaign_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v10_services_keyword_plan_campaign_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v10_services_keyword_plan_campaign_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v10_services_keyword_plan_campaign_service_proto_rawDescData)
	})
	return file_google_ads_googleads_v10_services_keyword_plan_campaign_service_proto_rawDescData
}

var file_google_ads_googleads_v10_services_keyword_plan_campaign_service_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_google_ads_googleads_v10_services_keyword_plan_campaign_service_proto_goTypes = []interface{}{
	(*MutateKeywordPlanCampaignsRequest)(nil),  // 0: google.ads.googleads.v10.services.MutateKeywordPlanCampaignsRequest
	(*KeywordPlanCampaignOperation)(nil),       // 1: google.ads.googleads.v10.services.KeywordPlanCampaignOperation
	(*MutateKeywordPlanCampaignsResponse)(nil), // 2: google.ads.googleads.v10.services.MutateKeywordPlanCampaignsResponse
	(*MutateKeywordPlanCampaignResult)(nil),    // 3: google.ads.googleads.v10.services.MutateKeywordPlanCampaignResult
	(*fieldmaskpb.FieldMask)(nil),              // 4: google.protobuf.FieldMask
	(*resources.KeywordPlanCampaign)(nil),      // 5: google.ads.googleads.v10.resources.KeywordPlanCampaign
	(*status.Status)(nil),                      // 6: google.rpc.Status
}
var file_google_ads_googleads_v10_services_keyword_plan_campaign_service_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v10.services.MutateKeywordPlanCampaignsRequest.operations:type_name -> google.ads.googleads.v10.services.KeywordPlanCampaignOperation
	4, // 1: google.ads.googleads.v10.services.KeywordPlanCampaignOperation.update_mask:type_name -> google.protobuf.FieldMask
	5, // 2: google.ads.googleads.v10.services.KeywordPlanCampaignOperation.create:type_name -> google.ads.googleads.v10.resources.KeywordPlanCampaign
	5, // 3: google.ads.googleads.v10.services.KeywordPlanCampaignOperation.update:type_name -> google.ads.googleads.v10.resources.KeywordPlanCampaign
	6, // 4: google.ads.googleads.v10.services.MutateKeywordPlanCampaignsResponse.partial_failure_error:type_name -> google.rpc.Status
	3, // 5: google.ads.googleads.v10.services.MutateKeywordPlanCampaignsResponse.results:type_name -> google.ads.googleads.v10.services.MutateKeywordPlanCampaignResult
	0, // 6: google.ads.googleads.v10.services.KeywordPlanCampaignService.MutateKeywordPlanCampaigns:input_type -> google.ads.googleads.v10.services.MutateKeywordPlanCampaignsRequest
	2, // 7: google.ads.googleads.v10.services.KeywordPlanCampaignService.MutateKeywordPlanCampaigns:output_type -> google.ads.googleads.v10.services.MutateKeywordPlanCampaignsResponse
...
func init() { file_google_ads_googleads_v10_services_keyword_plan_campaign_service_proto_init() }
func file_google_ads_googleads_v10_services_keyword_plan_campaign_service_proto_init() {
	if File_google_ads_googleads_v10_services_keyword_plan_campaign_service_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v10_services_keyword_plan_campaign_service_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v10_services_keyword_plan_campaign_service_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v10_services_keyword_plan_campaign_service_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v10_services_keyword_plan_campaign_service_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
	...
	file_google_ads_googleads_v10_services_keyword_plan_campaign_service_proto_msgTypes[1].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v10_services_keyword_plan_campaign_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v10_services_keyword_plan_campaign_service_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v10_services_keyword_plan_campaign_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v10_services_keyword_plan_campaign_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v10_services_keyword_plan_campaign_service_proto = out.File
	file_google_ads_googleads_v10_services_keyword_plan_campaign_service_proto_rawDesc = nil
	file_google_ads_googleads_v10_services_keyword_plan_campaign_service_proto_goTypes = nil
	file_google_ads_googleads_v10_services_keyword_plan_campaign_service_proto_depIdxs = nil
}
