...
func (x *MutateCustomerNegativeCriteriaRequest) Reset() {
	*x = MutateCustomerNegativeCriteriaRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v10_services_customer_negative_criterion_service_proto_msgTypes[0]
...
func (*MutateCustomerNegativeCriteriaRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v10_services_customer_negative_criterion_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *CustomerNegativeCriterionOperation) Reset() {
	*x = CustomerNegativeCriterionOperation{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v10_services_customer_negative_criterion_service_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*CustomerNegativeCriterionOperation) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v10_services_customer_negative_criterion_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *MutateCustomerNegativeCriteriaResponse) Reset() {
	*x = MutateCustomerNegativeCriteriaResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v10_services_customer_negative_criterion_service_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateCustomerNegativeCriteriaResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v10_services_customer_negative_criterion_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *MutateCustomerNegativeCriteriaResult) Reset() {
	*x = MutateCustomerNegativeCriteriaResult{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v10_services_customer_negative_criterion_service_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateCustomerNegativeCriteriaResult) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v10_services_customer_negative_criterion_service_proto_rawDescGZIP(), []int{3}
}
...
var file_google_ads_googleads_v10_services_customer_negative_criterion_service_proto_rawDesc = []byte{
	...
	0x73, 0x65, 0x22, 0x62, 0x82, 0xd3, 0xe4, 0x93, 0x02, 0x43, 0x22, 0x3e, 0x2f, 0x76, 0x31, 0x30,
...
var (
	file_google_ads_googleads_v10_services_customer_negative_criterion_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v10_services_customer_negative_criterion_service_proto_rawDescData = file_google_ads_googleads_v10_services_customer_negative_criterion_service_proto_rawDesc
)

func file_google_ads_googleads_v10_services_customer_negative_criterion_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v10_services_customer_negative_criterion_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v10_services_customer_negative_criterion_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v10_services_customer_negative_criterion_service_proto_rawDescData)
	})
	return file_google_ads_googleads_v10_services_customer_negative_criterion_service_proto_rawDescData
}

var file_google_ads_googleads_v10_services_customer_negative_criterion_service_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_google_ads_googleads_v10_services_customer_negative_criterion_service_proto_goTypes = []interface{}{
	(*MutateCustomerNegativeCriteriaRequest)(nil),          // 0: google.ads.googleads.v10.services.MutateCustomerNegativeCriteriaRequest
	(*CustomerNegativeCriterionOperation)(nil),             // 1: google.ads.googleads.v10.services.CustomerNegativeCriterionOperation
	(*MutateCustomerNegativeCriteriaResponse)(nil),         // 2: google.ads.googleads.v10.services.MutateCustomerNegativeCriteriaResponse
	(*MutateCustomerNegativeCriteriaResult)(nil),           // 3: google.ads.googleads.v10.services.MutateCustomerNegativeCriteriaResult
	...
	(*resources.CustomerNegativeCriterion)(nil),            // 5: google.ads.googleads.v10.resources.CustomerNegativeCriterion
	(*status.Status)(nil),                                  // 6: google.rpc.Status
}
var file_google_ads_googleads_v10_services_customer_negative_criterion_service_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v10.services.MutateCustomerNegativeCriteriaRequest.operations:type_name -> google.ads.googleads.v10.services.CustomerNegativeCriterionOperation
	4, // 1: google.ads.googleads.v10.services.MutateCustomerNegativeCriteriaRequest.response_content_type:type_name -> google.ads.googleads.v10.enums.ResponseContentTypeEnum.ResponseContentType
	5, // 2: google.ads.googleads.v10.services.CustomerNegativeCriterionOperation.create:type_name -> google.ads.googleads.v10.resources.CustomerNegativeCriterion
	6, // 3: google.ads.googleads.v10.services.MutateCustomerNegativeCriteriaResponse.partial_failure_error:type_name -> google.rpc.Status
	3, // 4: google.ads.googleads.v10.services.MutateCustomerNegativeCriteriaResponse.results:type_name -> google.ads.googleads.v10.services.MutateCustomerNegativeCriteriaResult
	5, // 5: google.ads.googleads.v10.services.MutateCustomerNegativeCriteriaResult.customer_negative_criterion:type_name -> google.ads.googleads.v10.resources.CustomerNegativeCriterion
	0, // 6: google.ads.googleads.v10.services.CustomerNegativeCriterionService.MutateCustomerNegativeCriteria:input_type -> google.ads.googleads.v10.services.MutateCustomerNegativeCriteriaRequest
	2, // 7: google.ads.googleads.v10.services.CustomerNegativeCriterionService.MutateCustomerNegativeCriteria:output_type -> google.ads.googleads.v10.services.MutateCustomerNegativeCriteriaResponse
...
func init() { file_google_ads_googleads_v10_services_customer_negative_criterion_service_proto_init() }
func file_google_ads_googleads_v10_services_customer_negative_criterion_service_proto_init() {
	if File_google_ads_googleads_v10_services_customer_negative_criterion_service_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v10_services_customer_negative_criterion_service_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v10_services_customer_negative_criterion_service_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v10_services_customer_negative_criterion_service_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v10_services_customer_negative_criterion_service_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
	...
	file_google_ads_googleads_v10_services_customer_negative_criterion_service_proto_msgTypes[1].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v10_services_customer_negative_criterion_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v10_services_customer_negative_criterion_service_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v10_services_customer_negative_criterion_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v10_services_customer_negative_criterion_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v10_services_customer_negative_criterion_service_proto = out.File
	file_google_ads_googleads_v10_services_customer_negative_criterion_service_proto_rawDesc = nil
	file_google_ads_googleads_v10_services_customer_negative_criterion_service_proto_goTypes = nil
	file_google_ads_googleads_v10_services_customer_negative_criterion_service_proto_depIdxs = nil
}
