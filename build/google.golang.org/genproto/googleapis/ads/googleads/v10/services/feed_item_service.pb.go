...
func (x *MutateFeedItemsRequest) Reset() {
	*x = MutateFeedItemsRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v10_services_feed_item_service_proto_msgTypes[0]
...
func (*MutateFeedItemsRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v10_services_feed_item_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *FeedItemOperation) Reset() {
	*x = FeedItemOperation{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v10_services_feed_item_service_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*FeedItemOperation) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v10_services_feed_item_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *MutateFeedItemsResponse) Reset() {
	*x = MutateFeedItemsResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v10_services_feed_item_service_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateFeedItemsResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v10_services_feed_item_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *MutateFeedItemResult) Reset() {
	*x = MutateFeedItemResult{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v10_services_feed_item_service_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateFeedItemResult) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v10_services_feed_item_service_proto_rawDescGZIP(), []int{3}
}
...
var file_google_ads_googleads_v10_services_feed_item_service_proto_rawDesc = []byte{
	...
	0x2f, 0x76, 0x31, 0x30, 0x2f, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x2f, 0x66,
	...
	0x22, 0x53, 0x82, 0xd3, 0xe4, 0x93, 0x02, 0x34, 0x22, 0x2f, 0x2f, 0x76, 0x31, 0x30, 0x2f, 0x63,
...
var (
	file_google_ads_googleads_v10_services_feed_item_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v10_services_feed_item_service_proto_rawDescData = file_google_ads_googleads_v10_services_feed_item_service_proto_rawDesc
)

func file_google_ads_googleads_v10_services_feed_item_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v10_services_feed_item_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v10_services_feed_item_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v10_services_feed_item_service_proto_rawDescData)
	})
	return file_google_ads_googleads_v10_services_feed_item_service_proto_rawDescData
}

var file_google_ads_googleads_v10_services_feed_item_service_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_google_ads_googleads_v10_services_feed_item_service_proto_goTypes = []interface{}{
	(*MutateFeedItemsRequest)(nil),                         // 0: google.ads.googleads.v10.services.MutateFeedItemsRequest
	(*FeedItemOperation)(nil),                              // 1: google.ads.googleads.v10.services.FeedItemOperation
	(*MutateFeedItemsResponse)(nil),                        // 2: google.ads.googleads.v10.services.MutateFeedItemsResponse
	(*MutateFeedItemResult)(nil),                           // 3: google.ads.googleads.v10.services.MutateFeedItemResult
	...
	(*resources.FeedItem)(nil),                             // 6: google.ads.googleads.v10.resources.FeedItem
	(*status.Status)(nil),                                  // 7: google.rpc.Status
}
var file_google_ads_googleads_v10_services_feed_item_service_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v10.services.MutateFeedItemsRequest.operations:type_name -> google.ads.googleads.v10.services.FeedItemOperation
	4, // 1: google.ads.googleads.v10.services.MutateFeedItemsRequest.response_content_type:type_name -> google.ads.googleads.v10.enums.ResponseContentTypeEnum.ResponseContentType
	5, // 2: google.ads.googleads.v10.services.FeedItemOperation.update_mask:type_name -> google.protobuf.FieldMask
	6, // 3: google.ads.googleads.v10.services.FeedItemOperation.create:type_name -> google.ads.googleads.v10.resources.FeedItem
	6, // 4: google.ads.googleads.v10.services.FeedItemOperation.update:type_name -> google.ads.googleads.v10.resources.FeedItem
	7, // 5: google.ads.googleads.v10.services.MutateFeedItemsResponse.partial_failure_error:type_name -> google.rpc.Status
	3, // 6: google.ads.googleads.v10.services.MutateFeedItemsResponse.results:type_name -> google.ads.googleads.v10.services.MutateFeedItemResult
	6, // 7: google.ads.googleads.v10.services.MutateFeedItemResult.feed_item:type_name -> google.ads.googleads.v10.resources.FeedItem
	0, // 8: google.ads.googleads.v10.services.FeedItemService.MutateFeedItems:input_type -> google.ads.googleads.v10.services.MutateFeedItemsRequest
	2, // 9: google.ads.googleads.v10.services.FeedItemService.MutateFeedItems:output_type -> google.ads.googleads.v10.services.MutateFeedItemsResponse
...
func init() { file_google_ads_googleads_v10_services_feed_item_service_proto_init() }
func file_google_ads_googleads_v10_services_feed_item_service_proto_init() {
	if File_google_ads_googleads_v10_services_feed_item_service_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v10_services_feed_item_service_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v10_services_feed_item_service_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v10_services_feed_item_service_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v10_services_feed_item_service_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
	...
	file_google_ads_googleads_v10_services_feed_item_service_proto_msgTypes[1].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v10_services_feed_item_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v10_services_feed_item_service_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v10_services_feed_item_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v10_services_feed_item_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v10_services_feed_item_service_proto = out.File
	file_google_ads_googleads_v10_services_feed_item_service_proto_rawDesc = nil
	file_google_ads_googleads_v10_services_feed_item_service_proto_goTypes = nil
	file_google_ads_googleads_v10_services_feed_item_service_proto_depIdxs = nil
}
...
func (c *feedItemServiceClient) MutateFeedItems(ctx context.Context, in *MutateFeedItemsRequest, opts ...grpc.CallOption) (*MutateFeedItemsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/google.ads.googleads.v10.services.FeedItemService/MutateFeedItems", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _FeedItemService_MutateFeedItems_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/google.ads.googleads.v10.services.FeedItemService/MutateFeedItems",
	}
