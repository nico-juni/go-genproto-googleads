...
func (x *MutateConversionCustomVariablesRequest) Reset() {
	*x = MutateConversionCustomVariablesRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v10_services_conversion_custom_variable_service_proto_msgTypes[0]
...
func (*MutateConversionCustomVariablesRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v10_services_conversion_custom_variable_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *ConversionCustomVariableOperation) Reset() {
	*x = ConversionCustomVariableOperation{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v10_services_conversion_custom_variable_service_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ConversionCustomVariableOperation) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v10_services_conversion_custom_variable_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *MutateConversionCustomVariablesResponse) Reset() {
	*x = MutateConversionCustomVariablesResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v10_services_conversion_custom_variable_service_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateConversionCustomVariablesResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v10_services_conversion_custom_variable_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *MutateConversionCustomVariableResult) Reset() {
	*x = MutateConversionCustomVariableResult{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v10_services_conversion_custom_variable_service_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateConversionCustomVariableResult) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v10_services_conversion_custom_variable_service_proto_rawDescGZIP(), []int{3}
}
...
var file_google_ads_googleads_v10_services_conversion_custom_variable_service_proto_rawDesc = []byte{
	...
	0x65, 0x22, 0x63, 0x82, 0xd3, 0xe4, 0x93, 0x02, 0x44, 0x22, 0x3f, 0x2f, 0x76, 0x31, 0x30, 0x2f,
...
var (
	file_google_ads_googleads_v10_services_conversion_custom_variable_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v10_services_conversion_custom_variable_service_proto_rawDescData = file_google_ads_googleads_v10_services_conversion_custom_variable_service_proto_rawDesc
)

func file_google_ads_googleads_v10_services_conversion_custom_variable_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v10_services_conversion_custom_variable_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v10_services_conversion_custom_variable_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v10_services_conversion_custom_variable_service_proto_rawDescData)
	})
	return file_google_ads_googleads_v10_services_conversion_custom_variable_service_proto_rawDescData
}

var file_google_ads_googleads_v10_services_conversion_custom_variable_service_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_google_ads_googleads_v10_services_conversion_custom_variable_service_proto_goTypes = []interface{}{
	(*MutateConversionCustomVariablesRequest)(nil),         // 0: google.ads.googleads.v10.services.MutateConversionCustomVariablesRequest
	(*ConversionCustomVariableOperation)(nil),              // 1: google.ads.googleads.v10.services.ConversionCustomVariableOperation
	(*MutateConversionCustomVariablesResponse)(nil),        // 2: google.ads.googleads.v10.services.MutateConversionCustomVariablesResponse
	(*MutateConversionCustomVariableResult)(nil),           // 3: google.ads.googleads.v10.services.MutateConversionCustomVariableResult
	...
	(*resources.ConversionCustomVariable)(nil),             // 6: google.ads.googleads.v10.resources.ConversionCustomVariable
	(*status.Status)(nil),                                  // 7: google.rpc.Status
}
var file_google_ads_googleads_v10_services_conversion_custom_variable_service_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v10.services.MutateConversionCustomVariablesRequest.operations:type_name -> google.ads.googleads.v10.services.ConversionCustomVariableOperation
	4, // 1: google.ads.googleads.v10.services.MutateConversionCustomVariablesRequest.response_content_type:type_name -> google.ads.googleads.v10.enums.ResponseContentTypeEnum.ResponseContentType
	5, // 2: google.ads.googleads.v10.services.ConversionCustomVariableOperation.update_mask:type_name -> google.protobuf.FieldMask
	6, // 3: google.ads.googleads.v10.services.ConversionCustomVariableOperation.create:type_name -> google.ads.googleads.v10.resources.ConversionCustomVariable
	6, // 4: google.ads.googleads.v10.services.ConversionCustomVariableOperation.update:type_name -> google.ads.googleads.v10.resources.ConversionCustomVariable
	7, // 5: google.ads.googleads.v10.services.MutateConversionCustomVariablesResponse.partial_failure_error:type_name -> google.rpc.Status
	3, // 6: google.ads.googleads.v10.services.MutateConversionCustomVariablesResponse.results:type_name -> google.ads.googleads.v10.services.MutateConversionCustomVariableResult
	6, // 7: google.ads.googleads.v10.services.MutateConversionCustomVariableResult.conversion_custom_variable:type_name -> google.ads.googleads.v10.resources.ConversionCustomVariable
	0, // 8: google.ads.googleads.v10.services.ConversionCustomVariableService.MutateConversionCustomVariables:input_type -> google.ads.googleads.v10.services.MutateConversionCustomVariablesRequest
	2, // 9: google.ads.googleads.v10.services.ConversionCustomVariableService.MutateConversionCustomVariables:output_type -> google.ads.googleads.v10.services.MutateConversionCustomVariablesResponse
...
func init() { file_google_ads_googleads_v10_services_conversion_custom_variable_service_proto_init() }
func file_google_ads_googleads_v10_services_conversion_custom_variable_service_proto_init() {
	if File_google_ads_googleads_v10_services_conversion_custom_variable_service_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v10_services_conversion_custom_variable_service_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v10_services_conversion_custom_variable_service_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v10_services_conversion_custom_variable_service_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v10_services_conversion_custom_variable_service_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
	...
	file_google_ads_googleads_v10_services_conversion_custom_variable_service_proto_msgTypes[1].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v10_services_conversion_custom_variable_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v10_services_conversion_custom_variable_service_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v10_services_conversion_custom_variable_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v10_services_conversion_custom_variable_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v10_services_conversion_custom_variable_service_proto = out.File
	file_google_ads_googleads_v10_services_conversion_custom_variable_service_proto_rawDesc = nil
	file_google_ads_googleads_v10_services_conversion_custom_variable_service_proto_goTypes = nil
	file_google_ads_googleads_v10_services_conversion_custom_variable_service_proto_depIdxs = nil
}
