...
func (x *MutateFeedItemSetsRequest) Reset() {
	*x = MutateFeedItemSetsRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v10_services_feed_item_set_service_proto_msgTypes[0]
...
func (*MutateFeedItemSetsRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v10_services_feed_item_set_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *FeedItemSetOperation) Reset() {
	*x = FeedItemSetOperation{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v10_services_feed_item_set_service_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*FeedItemSetOperation) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v10_services_feed_item_set_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *MutateFeedItemSetsResponse) Reset() {
	*x = MutateFeedItemSetsResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v10_services_feed_item_set_service_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateFeedItemSetsResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v10_services_feed_item_set_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *MutateFeedItemSetResult) Reset() {
	*x = MutateFeedItemSetResult{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v10_services_feed_item_set_service_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateFeedItemSetResult) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v10_services_feed_item_set_service_proto_rawDescGZIP(), []int{3}
}
...
var file_google_ads_googleads_v10_services_feed_item_set_service_proto_rawDesc = []byte{
...
var (
	file_google_ads_googleads_v10_services_feed_item_set_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v10_services_feed_item_set_service_proto_rawDescData = file_google_ads_googleads_v10_services_feed_item_set_service_proto_rawDesc
)

func file_google_ads_googleads_v10_services_feed_item_set_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v10_services_feed_item_set_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v10_services_feed_item_set_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v10_services_feed_item_set_service_proto_rawDescData)
	})
	return file_google_ads_googleads_v10_services_feed_item_set_service_proto_rawDescData
}

var file_google_ads_googleads_v10_services_feed_item_set_service_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_google_ads_googleads_v10_services_feed_item_set_service_proto_goTypes = []interface{}{
	(*MutateFeedItemSetsRequest)(nil),  // 0: google.ads.googleads.v10.services.MutateFeedItemSetsRequest
	(*FeedItemSetOperation)(nil),       // 1: google.ads.googleads.v10.services.FeedItemSetOperation
	(*MutateFeedItemSetsResponse)(nil), // 2: google.ads.googleads.v10.services.MutateFeedItemSetsResponse
	(*MutateFeedItemSetResult)(nil),    // 3: google.ads.googleads.v10.services.MutateFeedItemSetResult
	(*fieldmaskpb.FieldMask)(nil),      // 4: google.protobuf.FieldMask
	(*resources.FeedItemSet)(nil),      // 5: google.ads.googleads.v10.resources.FeedItemSet
	(*status.Status)(nil),              // 6: google.rpc.Status
}
var file_google_ads_googleads_v10_services_feed_item_set_service_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v10.services.MutateFeedItemSetsRequest.operations:type_name -> google.ads.googleads.v10.services.FeedItemSetOperation
	4, // 1: google.ads.googleads.v10.services.FeedItemSetOperation.update_mask:type_name -> google.protobuf.FieldMask
	5, // 2: google.ads.googleads.v10.services.FeedItemSetOperation.create:type_name -> google.ads.googleads.v10.resources.FeedItemSet
	5, // 3: google.ads.googleads.v10.services.FeedItemSetOperation.update:type_name -> google.ads.googleads.v10.resources.FeedItemSet
	3, // 4: google.ads.googleads.v10.services.MutateFeedItemSetsResponse.results:type_name -> google.ads.googleads.v10.services.MutateFeedItemSetResult
	6, // 5: google.ads.googleads.v10.services.MutateFeedItemSetsResponse.partial_failure_error:type_name -> google.rpc.Status
	0, // 6: google.ads.googleads.v10.services.FeedItemSetService.MutateFeedItemSets:input_type -> google.ads.googleads.v10.services.MutateFeedItemSetsRequest
	2, // 7: google.ads.googleads.v10.services.FeedItemSetService.MutateFeedItemSets:output_type -> google.ads.googleads.v10.services.MutateFeedItemSetsResponse
...
func init() { file_google_ads_googleads_v10_services_feed_item_set_service_proto_init() }
func file_google_ads_googleads_v10_services_feed_item_set_service_proto_init() {
	if File_google_ads_googleads_v10_services_feed_item_set_service_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v10_services_feed_item_set_service_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v10_services_feed_item_set_service_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v10_services_feed_item_set_service_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v10_services_feed_item_set_service_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
	...
	file_google_ads_googleads_v10_services_feed_item_set_service_proto_msgTypes[1].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v10_services_feed_item_set_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v10_services_feed_item_set_service_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v10_services_feed_item_set_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v10_services_feed_item_set_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v10_services_feed_item_set_service_proto = out.File
	file_google_ads_googleads_v10_services_feed_item_set_service_proto_rawDesc = nil
	file_google_ads_googleads_v10_services_feed_item_set_service_proto_goTypes = nil
	file_google_ads_googleads_v10_services_feed_item_set_service_proto_depIdxs = nil
}
