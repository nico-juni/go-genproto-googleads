...
func (x *MutateCustomInterestsRequest) Reset() {
	*x = MutateCustomInterestsRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v10_services_custom_interest_service_proto_msgTypes[0]
...
func (*MutateCustomInterestsRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v10_services_custom_interest_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *CustomInterestOperation) Reset() {
	*x = CustomInterestOperation{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v10_services_custom_interest_service_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*CustomInterestOperation) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v10_services_custom_interest_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *MutateCustomInterestsResponse) Reset() {
	*x = MutateCustomInterestsResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v10_services_custom_interest_service_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateCustomInterestsResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v10_services_custom_interest_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *MutateCustomInterestResult) Reset() {
	*x = MutateCustomInterestResult{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v10_services_custom_interest_service_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateCustomInterestResult) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v10_services_custom_interest_service_proto_rawDescGZIP(), []int{3}
}
...
var file_google_ads_googleads_v10_services_custom_interest_service_proto_rawDesc = []byte{
...
var (
	file_google_ads_googleads_v10_services_custom_interest_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v10_services_custom_interest_service_proto_rawDescData = file_google_ads_googleads_v10_services_custom_interest_service_proto_rawDesc
)

func file_google_ads_googleads_v10_services_custom_interest_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v10_services_custom_interest_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v10_services_custom_interest_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v10_services_custom_interest_service_proto_rawDescData)
	})
	return file_google_ads_googleads_v10_services_custom_interest_service_proto_rawDescData
}

var file_google_ads_googleads_v10_services_custom_interest_service_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_google_ads_googleads_v10_services_custom_interest_service_proto_goTypes = []interface{}{
	(*MutateCustomInterestsRequest)(nil),  // 0: google.ads.googleads.v10.services.MutateCustomInterestsRequest
	(*CustomInterestOperation)(nil),       // 1: google.ads.googleads.v10.services.CustomInterestOperation
	(*MutateCustomInterestsResponse)(nil), // 2: google.ads.googleads.v10.services.MutateCustomInterestsResponse
	(*MutateCustomInterestResult)(nil),    // 3: google.ads.googleads.v10.services.MutateCustomInterestResult
	(*fieldmaskpb.FieldMask)(nil),         // 4: google.protobuf.FieldMask
	(*resources.CustomInterest)(nil),      // 5: google.ads.googleads.v10.resources.CustomInterest
}
var file_google_ads_googleads_v10_services_custom_interest_service_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v10.services.MutateCustomInterestsRequest.operations:type_name -> google.ads.googleads.v10.services.CustomInterestOperation
	4, // 1: google.ads.googleads.v10.services.CustomInterestOperation.update_mask:type_name -> google.protobuf.FieldMask
	5, // 2: google.ads.googleads.v10.services.CustomInterestOperation.create:type_name -> google.ads.googleads.v10.resources.CustomInterest
	5, // 3: google.ads.googleads.v10.services.CustomInterestOperation.update:type_name -> google.ads.googleads.v10.resources.CustomInterest
	3, // 4: google.ads.googleads.v10.services.MutateCustomInterestsResponse.results:type_name -> google.ads.googleads.v10.services.MutateCustomInterestResult
	0, // 5: google.ads.googleads.v10.services.CustomInterestService.MutateCustomInterests:input_type -> google.ads.googleads.v10.services.MutateCustomInterestsRequest
	2, // 6: google.ads.googleads.v10.services.CustomInterestService.MutateCustomInterests:output_type -> google.ads.googleads.v10.services.MutateCustomInterestsResponse
...
func init() { file_google_ads_googleads_v10_services_custom_interest_service_proto_init() }
func file_google_ads_googleads_v10_services_custom_interest_service_proto_init() {
	if File_google_ads_googleads_v10_services_custom_interest_service_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v10_services_custom_interest_service_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v10_services_custom_interest_service_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v10_services_custom_interest_service_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v10_services_custom_interest_service_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
	...
	file_google_ads_googleads_v10_services_custom_interest_service_proto_msgTypes[1].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v10_services_custom_interest_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v10_services_custom_interest_service_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v10_services_custom_interest_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v10_services_custom_interest_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v10_services_custom_interest_service_proto = out.File
	file_google_ads_googleads_v10_services_custom_interest_service_proto_rawDesc = nil
	file_google_ads_googleads_v10_services_custom_interest_service_proto_goTypes = nil
	file_google_ads_googleads_v10_services_custom_interest_service_proto_depIdxs = nil
}
