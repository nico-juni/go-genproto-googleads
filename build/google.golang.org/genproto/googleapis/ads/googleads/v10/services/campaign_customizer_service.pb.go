...
func (x *MutateCampaignCustomizersRequest) Reset() {
	*x = MutateCampaignCustomizersRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v10_services_campaign_customizer_service_proto_msgTypes[0]
...
func (*MutateCampaignCustomizersRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v10_services_campaign_customizer_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *CampaignCustomizerOperation) Reset() {
	*x = CampaignCustomizerOperation{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v10_services_campaign_customizer_service_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*CampaignCustomizerOperation) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v10_services_campaign_customizer_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *MutateCampaignCustomizersResponse) Reset() {
	*x = MutateCampaignCustomizersResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v10_services_campaign_customizer_service_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateCampaignCustomizersResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v10_services_campaign_customizer_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *MutateCampaignCustomizerResult) Reset() {
	*x = MutateCampaignCustomizerResult{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v10_services_campaign_customizer_service_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateCampaignCustomizerResult) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v10_services_campaign_customizer_service_proto_rawDescGZIP(), []int{3}
}
...
var file_google_ads_googleads_v10_services_campaign_customizer_service_proto_rawDesc = []byte{
	...
	0x64, 0x73, 0x2e, 0x76, 0x31, 0x30, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2e, 0x52, 0x65, 0x73,
	...
	0xd3, 0xe4, 0x93, 0x02, 0x3e, 0x22, 0x39, 0x2f, 0x76, 0x31, 0x30, 0x2f, 0x63, 0x75, 0x73, 0x74,
	...
	0x2e, 0x76, 0x31, 0x30, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x42, 0x1e, 0x43,
	0x61, 0x6d, 0x70, 0x61, 0x69, 0x67, 0x6e, 0x43, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x69, 0x7a, 0x65,
...
var (
	file_google_ads_googleads_v10_services_campaign_customizer_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v10_services_campaign_customizer_service_proto_rawDescData = file_google_ads_googleads_v10_services_campaign_customizer_service_proto_rawDesc
)

func file_google_ads_googleads_v10_services_campaign_customizer_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v10_services_campaign_customizer_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v10_services_campaign_customizer_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v10_services_campaign_customizer_service_proto_rawDescData)
	})
	return file_google_ads_googleads_v10_services_campaign_customizer_service_proto_rawDescData
}

var file_google_ads_googleads_v10_services_campaign_customizer_service_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_google_ads_googleads_v10_services_campaign_customizer_service_proto_goTypes = []interface{}{
	(*MutateCampaignCustomizersRequest)(nil),               // 0: google.ads.googleads.v10.services.MutateCampaignCustomizersRequest
	(*CampaignCustomizerOperation)(nil),                    // 1: google.ads.googleads.v10.services.CampaignCustomizerOperation
	(*MutateCampaignCustomizersResponse)(nil),              // 2: google.ads.googleads.v10.services.MutateCampaignCustomizersResponse
	(*MutateCampaignCustomizerResult)(nil),                 // 3: google.ads.googleads.v10.services.MutateCampaignCustomizerResult
	...
	(*resources.CampaignCustomizer)(nil),                   // 5: google.ads.googleads.v10.resources.CampaignCustomizer
	(*status.Status)(nil),                                  // 6: google.rpc.Status
}
var file_google_ads_googleads_v10_services_campaign_customizer_service_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v10.services.MutateCampaignCustomizersRequest.operations:type_name -> google.ads.googleads.v10.services.CampaignCustomizerOperation
	4, // 1: google.ads.googleads.v10.services.MutateCampaignCustomizersRequest.response_content_type:type_name -> google.ads.googleads.v10.enums.ResponseContentTypeEnum.ResponseContentType
	5, // 2: google.ads.googleads.v10.services.CampaignCustomizerOperation.create:type_name -> google.ads.googleads.v10.resources.CampaignCustomizer
	3, // 3: google.ads.googleads.v10.services.MutateCampaignCustomizersResponse.results:type_name -> google.ads.googleads.v10.services.MutateCampaignCustomizerResult
	6, // 4: google.ads.googleads.v10.services.MutateCampaignCustomizersResponse.partial_failure_error:type_name -> google.rpc.Status
	5, // 5: google.ads.googleads.v10.services.MutateCampaignCustomizerResult.campaign_customizer:type_name -> google.ads.googleads.v10.resources.CampaignCustomizer
	0, // 6: google.ads.googleads.v10.services.CampaignCustomizerService.MutateCampaignCustomizers:input_type -> google.ads.googleads.v10.services.MutateCampaignCustomizersRequest
	2, // 7: google.ads.googleads.v10.services.CampaignCustomizerService.MutateCampaignCustomizers:output_type -> google.ads.googleads.v10.services.MutateCampaignCustomizersResponse
...
func init() { file_google_ads_googleads_v10_services_campaign_customizer_service_proto_init() }
func file_google_ads_googleads_v10_services_campaign_customizer_service_proto_init() {
	if File_google_ads_googleads_v10_services_campaign_customizer_service_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v10_services_campaign_customizer_service_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v10_services_campaign_customizer_service_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v10_services_campaign_customizer_service_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v10_services_campaign_customizer_service_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
	...
	file_google_ads_googleads_v10_services_campaign_customizer_service_proto_msgTypes[1].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v10_services_campaign_customizer_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v10_services_campaign_customizer_service_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v10_services_campaign_customizer_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v10_services_campaign_customizer_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v10_services_campaign_customizer_service_proto = out.File
	file_google_ads_googleads_v10_services_campaign_customizer_service_proto_rawDesc = nil
	file_google_ads_googleads_v10_services_campaign_customizer_service_proto_goTypes = nil
	file_google_ads_googleads_v10_services_campaign_customizer_service_proto_depIdxs = nil
}
...
// UnimplementedCampaignCustomizerServiceServer can be embedded to have forward compatible implementations.
...
func (*UnimplementedCampaignCustomizerServiceServer) MutateCampaignCustomizers(context.Context, *MutateCampaignCustomizersRequest) (*MutateCampaignCustomizersResponse, error) {
	return nil, status1.Errorf(codes.Unimplemented, "method MutateCampaignCustomizers not implemented")
}

func RegisterCampaignCustomizerServiceServer(s *grpc.Server, srv CampaignCustomizerServiceServer) {
	s.RegisterService(&_CampaignCustomizerService_serviceDesc, srv)
}
...
var _CampaignCustomizerService_serviceDesc = grpc.ServiceDesc{
