...
func (x *MutateAdGroupCriterionLabelsRequest) Reset() {
	*x = MutateAdGroupCriterionLabelsRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v10_services_ad_group_criterion_label_service_proto_msgTypes[0]
...
func (*MutateAdGroupCriterionLabelsRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v10_services_ad_group_criterion_label_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *AdGroupCriterionLabelOperation) Reset() {
	*x = AdGroupCriterionLabelOperation{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v10_services_ad_group_criterion_label_service_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*AdGroupCriterionLabelOperation) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v10_services_ad_group_criterion_label_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *MutateAdGroupCriterionLabelsResponse) Reset() {
	*x = MutateAdGroupCriterionLabelsResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v10_services_ad_group_criterion_label_service_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateAdGroupCriterionLabelsResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v10_services_ad_group_criterion_label_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *MutateAdGroupCriterionLabelResult) Reset() {
	*x = MutateAdGroupCriterionLabelResult{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v10_services_ad_group_criterion_label_service_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateAdGroupCriterionLabelResult) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v10_services_ad_group_criterion_label_service_proto_rawDescGZIP(), []int{3}
}
...
var file_google_ads_googleads_v10_services_ad_group_criterion_label_service_proto_rawDesc = []byte{
	...
	0x3c, 0x2f, 0x76, 0x31, 0x30, 0x2f, 0x63, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x65, 0x72, 0x73, 0x2f,
	...
	0x61, 0x64, 0x73, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x61, 0x64, 0x73, 0x2e, 0x76, 0x31,
	0x30, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x42, 0x21, 0x41, 0x64, 0x47, 0x72,
...
var (
	file_google_ads_googleads_v10_services_ad_group_criterion_label_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v10_services_ad_group_criterion_label_service_proto_rawDescData = file_google_ads_googleads_v10_services_ad_group_criterion_label_service_proto_rawDesc
)

func file_google_ads_googleads_v10_services_ad_group_criterion_label_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v10_services_ad_group_criterion_label_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v10_services_ad_group_criterion_label_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v10_services_ad_group_criterion_label_service_proto_rawDescData)
	})
	return file_google_ads_googleads_v10_services_ad_group_criterion_label_service_proto_rawDescData
}

var file_google_ads_googleads_v10_services_ad_group_criterion_label_service_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_google_ads_googleads_v10_services_ad_group_criterion_label_service_proto_goTypes = []interface{}{
	(*MutateAdGroupCriterionLabelsRequest)(nil),  // 0: google.ads.googleads.v10.services.MutateAdGroupCriterionLabelsRequest
	(*AdGroupCriterionLabelOperation)(nil),       // 1: google.ads.googleads.v10.services.AdGroupCriterionLabelOperation
	(*MutateAdGroupCriterionLabelsResponse)(nil), // 2: google.ads.googleads.v10.services.MutateAdGroupCriterionLabelsResponse
	(*MutateAdGroupCriterionLabelResult)(nil),    // 3: google.ads.googleads.v10.services.MutateAdGroupCriterionLabelResult
	(*resources.AdGroupCriterionLabel)(nil),      // 4: google.ads.googleads.v10.resources.AdGroupCriterionLabel
	(*status.Status)(nil),                        // 5: google.rpc.Status
}
var file_google_ads_googleads_v10_services_ad_group_criterion_label_service_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v10.services.MutateAdGroupCriterionLabelsRequest.operations:type_name -> google.ads.googleads.v10.services.AdGroupCriterionLabelOperation
	4, // 1: google.ads.googleads.v10.services.AdGroupCriterionLabelOperation.create:type_name -> google.ads.googleads.v10.resources.AdGroupCriterionLabel
	5, // 2: google.ads.googleads.v10.services.MutateAdGroupCriterionLabelsResponse.partial_failure_error:type_name -> google.rpc.Status
	3, // 3: google.ads.googleads.v10.services.MutateAdGroupCriterionLabelsResponse.results:type_name -> google.ads.googleads.v10.services.MutateAdGroupCriterionLabelResult
	0, // 4: google.ads.googleads.v10.services.AdGroupCriterionLabelService.MutateAdGroupCriterionLabels:input_type -> google.ads.googleads.v10.services.MutateAdGroupCriterionLabelsRequest
	2, // 5: google.ads.googleads.v10.services.AdGroupCriterionLabelService.MutateAdGroupCriterionLabels:output_type -> google.ads.googleads.v10.services.MutateAdGroupCriterionLabelsResponse
...
func init() { file_google_ads_googleads_v10_services_ad_group_criterion_label_service_proto_init() }
func file_google_ads_googleads_v10_services_ad_group_criterion_label_service_proto_init() {
	if File_google_ads_googleads_v10_services_ad_group_criterion_label_service_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v10_services_ad_group_criterion_label_service_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v10_services_ad_group_criterion_label_service_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v10_services_ad_group_criterion_label_service_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v10_services_ad_group_criterion_label_service_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
	...
	file_google_ads_googleads_v10_services_ad_group_criterion_label_service_proto_msgTypes[1].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v10_services_ad_group_criterion_label_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v10_services_ad_group_criterion_label_service_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v10_services_ad_group_criterion_label_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v10_services_ad_group_criterion_label_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v10_services_ad_group_criterion_label_service_proto = out.File
	file_google_ads_googleads_v10_services_ad_group_criterion_label_service_proto_rawDesc = nil
	file_google_ads_googleads_v10_services_ad_group_criterion_label_service_proto_goTypes = nil
	file_google_ads_googleads_v10_services_ad_group_criterion_label_service_proto_depIdxs = nil
}
