...
func (x *MutateAssetGroupAssetsRequest) Reset() {
	*x = MutateAssetGroupAssetsRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v10_services_asset_group_asset_service_proto_msgTypes[0]
...
func (*MutateAssetGroupAssetsRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v10_services_asset_group_asset_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *AssetGroupAssetOperation) Reset() {
	*x = AssetGroupAssetOperation{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v10_services_asset_group_asset_service_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*AssetGroupAssetOperation) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v10_services_asset_group_asset_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *MutateAssetGroupAssetsResponse) Reset() {
	*x = MutateAssetGroupAssetsResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v10_services_asset_group_asset_service_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateAssetGroupAssetsResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v10_services_asset_group_asset_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *MutateAssetGroupAssetResult) Reset() {
	*x = MutateAssetGroupAssetResult{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v10_services_asset_group_asset_service_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateAssetGroupAssetResult) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v10_services_asset_group_asset_service_proto_rawDescGZIP(), []int{3}
}
...
var file_google_ads_googleads_v10_services_asset_group_asset_service_proto_rawDesc = []byte{
	...
	0x3b, 0x22, 0x36, 0x2f, 0x76, 0x31, 0x30, 0x2f, 0x63, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x65, 0x72,
...
var (
	file_google_ads_googleads_v10_services_asset_group_asset_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v10_services_asset_group_asset_service_proto_rawDescData = file_google_ads_googleads_v10_services_asset_group_asset_service_proto_rawDesc
)

func file_google_ads_googleads_v10_services_asset_group_asset_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v10_services_asset_group_asset_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v10_services_asset_group_asset_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v10_services_asset_group_asset_service_proto_rawDescData)
	})
	return file_google_ads_googleads_v10_services_asset_group_asset_service_proto_rawDescData
}

var file_google_ads_googleads_v10_services_asset_group_asset_service_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_google_ads_googleads_v10_services_asset_group_asset_service_proto_goTypes = []interface{}{
	(*MutateAssetGroupAssetsRequest)(nil),  // 0: google.ads.googleads.v10.services.MutateAssetGroupAssetsRequest
	(*AssetGroupAssetOperation)(nil),       // 1: google.ads.googleads.v10.services.AssetGroupAssetOperation
	(*MutateAssetGroupAssetsResponse)(nil), // 2: google.ads.googleads.v10.services.MutateAssetGroupAssetsResponse
	(*MutateAssetGroupAssetResult)(nil),    // 3: google.ads.googleads.v10.services.MutateAssetGroupAssetResult
	(*fieldmaskpb.FieldMask)(nil),          // 4: google.protobuf.FieldMask
	(*resources.AssetGroupAsset)(nil),      // 5: google.ads.googleads.v10.resources.AssetGroupAsset
	(*status.Status)(nil),                  // 6: google.rpc.Status
}
var file_google_ads_googleads_v10_services_asset_group_asset_service_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v10.services.MutateAssetGroupAssetsRequest.operations:type_name -> google.ads.googleads.v10.services.AssetGroupAssetOperation
	4, // 1: google.ads.googleads.v10.services.AssetGroupAssetOperation.update_mask:type_name -> google.protobuf.FieldMask
	5, // 2: google.ads.googleads.v10.services.AssetGroupAssetOperation.create:type_name -> google.ads.googleads.v10.resources.AssetGroupAsset
	5, // 3: google.ads.googleads.v10.services.AssetGroupAssetOperation.update:type_name -> google.ads.googleads.v10.resources.AssetGroupAsset
	3, // 4: google.ads.googleads.v10.services.MutateAssetGroupAssetsResponse.results:type_name -> google.ads.googleads.v10.services.MutateAssetGroupAssetResult
	6, // 5: google.ads.googleads.v10.services.MutateAssetGroupAssetsResponse.partial_failure_error:type_name -> google.rpc.Status
	0, // 6: google.ads.googleads.v10.services.AssetGroupAssetService.MutateAssetGroupAssets:input_type -> google.ads.googleads.v10.services.MutateAssetGroupAssetsRequest
	2, // 7: google.ads.googleads.v10.services.AssetGroupAssetService.MutateAssetGroupAssets:output_type -> google.ads.googleads.v10.services.MutateAssetGroupAssetsResponse
...
func init() { file_google_ads_googleads_v10_services_asset_group_asset_service_proto_init() }
func file_google_ads_googleads_v10_services_asset_group_asset_service_proto_init() {
	if File_google_ads_googleads_v10_services_asset_group_asset_service_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v10_services_asset_group_asset_service_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v10_services_asset_group_asset_service_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v10_services_asset_group_asset_service_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v10_services_asset_group_asset_service_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
	...
	file_google_ads_googleads_v10_services_asset_group_asset_service_proto_msgTypes[1].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v10_services_asset_group_asset_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v10_services_asset_group_asset_service_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v10_services_asset_group_asset_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v10_services_asset_group_asset_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v10_services_asset_group_asset_service_proto = out.File
	file_google_ads_googleads_v10_services_asset_group_asset_service_proto_rawDesc = nil
	file_google_ads_googleads_v10_services_asset_group_asset_service_proto_goTypes = nil
	file_google_ads_googleads_v10_services_asset_group_asset_service_proto_depIdxs = nil
}
...
// UnimplementedAssetGroupAssetServiceServer can be embedded to have forward compatible implementations.
...
func (*UnimplementedAssetGroupAssetServiceServer) MutateAssetGroupAssets(context.Context, *MutateAssetGroupAssetsRequest) (*MutateAssetGroupAssetsResponse, error) {
	return nil, status1.Errorf(codes.Unimplemented, "method MutateAssetGroupAssets not implemented")
}

func RegisterAssetGroupAssetServiceServer(s *grpc.Server, srv AssetGroupAssetServiceServer) {
	s.RegisterService(&_AssetGroupAssetService_serviceDesc, srv)
}
...
var _AssetGroupAssetService_serviceDesc = grpc.ServiceDesc{
