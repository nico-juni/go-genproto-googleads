...
func (x *MutateAdGroupCriterionCustomizersRequest) Reset() {
	*x = MutateAdGroupCriterionCustomizersRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v10_services_ad_group_criterion_customizer_service_proto_msgTypes[0]
...
func (*MutateAdGroupCriterionCustomizersRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v10_services_ad_group_criterion_customizer_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *AdGroupCriterionCustomizerOperation) Reset() {
	*x = AdGroupCriterionCustomizerOperation{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v10_services_ad_group_criterion_customizer_service_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*AdGroupCriterionCustomizerOperation) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v10_services_ad_group_criterion_customizer_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *MutateAdGroupCriterionCustomizersResponse) Reset() {
	*x = MutateAdGroupCriterionCustomizersResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v10_services_ad_group_criterion_customizer_service_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateAdGroupCriterionCustomizersResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v10_services_ad_group_criterion_customizer_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *MutateAdGroupCriterionCustomizerResult) Reset() {
	*x = MutateAdGroupCriterionCustomizerResult{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v10_services_ad_group_criterion_customizer_service_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateAdGroupCriterionCustomizerResult) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v10_services_ad_group_criterion_customizer_service_proto_rawDescGZIP(), []int{3}
}
...
var file_google_ads_googleads_v10_services_ad_group_criterion_customizer_service_proto_rawDesc = []byte{
	...
	0x76, 0x31, 0x30, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x42, 0x26, 0x41, 0x64,
	0x47, 0x72, 0x6f, 0x75, 0x70, 0x43, 0x72, 0x69, 0x74, 0x65, 0x72, 0x69, 0x6f, 0x6e, 0x43, 0x75,
...
var (
	file_google_ads_googleads_v10_services_ad_group_criterion_customizer_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v10_services_ad_group_criterion_customizer_service_proto_rawDescData = file_google_ads_googleads_v10_services_ad_group_criterion_customizer_service_proto_rawDesc
)

func file_google_ads_googleads_v10_services_ad_group_criterion_customizer_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v10_services_ad_group_criterion_customizer_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v10_services_ad_group_criterion_customizer_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v10_services_ad_group_criterion_customizer_service_proto_rawDescData)
	})
	return file_google_ads_googleads_v10_services_ad_group_criterion_customizer_service_proto_rawDescData
}

var file_google_ads_googleads_v10_services_ad_group_criterion_customizer_service_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_google_ads_googleads_v10_services_ad_group_criterion_customizer_service_proto_goTypes = []interface{}{
	(*MutateAdGroupCriterionCustomizersRequest)(nil),       // 0: google.ads.googleads.v10.services.MutateAdGroupCriterionCustomizersRequest
	(*AdGroupCriterionCustomizerOperation)(nil),            // 1: google.ads.googleads.v10.services.AdGroupCriterionCustomizerOperation
	(*MutateAdGroupCriterionCustomizersResponse)(nil),      // 2: google.ads.googleads.v10.services.MutateAdGroupCriterionCustomizersResponse
	(*MutateAdGroupCriterionCustomizerResult)(nil),         // 3: google.ads.googleads.v10.services.MutateAdGroupCriterionCustomizerResult
	...
	(*resources.AdGroupCriterionCustomizer)(nil),           // 5: google.ads.googleads.v10.resources.AdGroupCriterionCustomizer
	(*status.Status)(nil),                                  // 6: google.rpc.Status
}
var file_google_ads_googleads_v10_services_ad_group_criterion_customizer_service_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v10.services.MutateAdGroupCriterionCustomizersRequest.operations:type_name -> google.ads.googleads.v10.services.AdGroupCriterionCustomizerOperation
	4, // 1: google.ads.googleads.v10.services.MutateAdGroupCriterionCustomizersRequest.response_content_type:type_name -> google.ads.googleads.v10.enums.ResponseContentTypeEnum.ResponseContentType
	5, // 2: google.ads.googleads.v10.services.AdGroupCriterionCustomizerOperation.create:type_name -> google.ads.googleads.v10.resources.AdGroupCriterionCustomizer
	3, // 3: google.ads.googleads.v10.services.MutateAdGroupCriterionCustomizersResponse.results:type_name -> google.ads.googleads.v10.services.MutateAdGroupCriterionCustomizerResult
	6, // 4: google.ads.googleads.v10.services.MutateAdGroupCriterionCustomizersResponse.partial_failure_error:type_name -> google.rpc.Status
	5, // 5: google.ads.googleads.v10.services.MutateAdGroupCriterionCustomizerResult.ad_group_criterion_customizer:type_name -> google.ads.googleads.v10.resources.AdGroupCriterionCustomizer
	0, // 6: google.ads.googleads.v10.services.AdGroupCriterionCustomizerService.MutateAdGroupCriterionCustomizers:input_type -> google.ads.googleads.v10.services.MutateAdGroupCriterionCustomizersRequest
	2, // 7: google.ads.googleads.v10.services.AdGroupCriterionCustomizerService.MutateAdGroupCriterionCustomizers:output_type -> google.ads.googleads.v10.services.MutateAdGroupCriterionCustomizersResponse
...
func file_google_ads_googleads_v10_services_ad_group_criterion_customizer_service_proto_init() {
	if File_google_ads_googleads_v10_services_ad_group_criterion_customizer_service_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v10_services_ad_group_criterion_customizer_service_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v10_services_ad_group_criterion_customizer_service_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v10_services_ad_group_criterion_customizer_service_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v10_services_ad_group_criterion_customizer_service_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
	...
	file_google_ads_googleads_v10_services_ad_group_criterion_customizer_service_proto_msgTypes[1].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v10_services_ad_group_criterion_customizer_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v10_services_ad_group_criterion_customizer_service_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v10_services_ad_group_criterion_customizer_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v10_services_ad_group_criterion_customizer_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v10_services_ad_group_criterion_customizer_service_proto = out.File
	file_google_ads_googleads_v10_services_ad_group_criterion_customizer_service_proto_rawDesc = nil
	file_google_ads_googleads_v10_services_ad_group_criterion_customizer_service_proto_goTypes = nil
	file_google_ads_googleads_v10_services_ad_group_criterion_customizer_service_proto_depIdxs = nil
}
...
func (c *adGroupCriterionCustomizerServiceClient) MutateAdGroupCriterionCustomizers(ctx context.Context, in *MutateAdGroupCriterionCustomizersRequest, opts ...grpc.CallOption) (*MutateAdGroupCriterionCustomizersResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/google.ads.googleads.v10.services.AdGroupCriterionCustomizerService/MutateAdGroupCriterionCustomizers", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedAdGroupCriterionCustomizerServiceServer can be embedded to have forward compatible implementations.
...
func (*UnimplementedAdGroupCriterionCustomizerServiceServer) MutateAdGroupCriterionCustomizers(context.Context, *MutateAdGroupCriterionCustomizersRequest) (*MutateAdGroupCriterionCustomizersResponse, error) {
	return nil, status1.Errorf(codes.Unimplemented, "method MutateAdGroupCriterionCustomizers not implemented")
}

func RegisterAdGroupCriterionCustomizerServiceServer(s *grpc.Server, srv AdGroupCriterionCustomizerServiceServer) {
	s.RegisterService(&_AdGroupCriterionCustomizerService_serviceDesc, srv)
}
...
func _AdGroupCriterionCustomizerService_MutateAdGroupCriterionCustomizers_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/google.ads.googleads.v10.services.AdGroupCriterionCustomizerService/MutateAdGroupCriterionCustomizers",
	}
...
var _AdGroupCriterionCustomizerService_serviceDesc = grpc.ServiceDesc{
