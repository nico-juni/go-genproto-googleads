...
func (x *MutateRemarketingActionsRequest) Reset() {
	*x = MutateRemarketingActionsRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v10_services_remarketing_action_service_proto_msgTypes[0]
...
func (*MutateRemarketingActionsRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v10_services_remarketing_action_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *RemarketingActionOperation) Reset() {
	*x = RemarketingActionOperation{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v10_services_remarketing_action_service_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*RemarketingActionOperation) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v10_services_remarketing_action_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *MutateRemarketingActionsResponse) Reset() {
	*x = MutateRemarketingActionsResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v10_services_remarketing_action_service_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateRemarketingActionsResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v10_services_remarketing_action_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *MutateRemarketingActionResult) Reset() {
	*x = MutateRemarketingActionResult{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v10_services_remarketing_action_service_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateRemarketingActionResult) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v10_services_remarketing_action_service_proto_rawDescGZIP(), []int{3}
}
...
var file_google_ads_googleads_v10_services_remarketing_action_service_proto_rawDesc = []byte{
	...
	0x30, 0x2f, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x2f, 0x72, 0x65, 0x6d, 0x61,
	...
	0xe4, 0x93, 0x02, 0x3d, 0x22, 0x38, 0x2f, 0x76, 0x31, 0x30, 0x2f, 0x63, 0x75, 0x73, 0x74, 0x6f,
	...
	0x2e, 0x61, 0x64, 0x73, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x61, 0x64, 0x73, 0x2e, 0x76,
	0x31, 0x30, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x42, 0x1d, 0x52, 0x65, 0x6d,
...
var (
	file_google_ads_googleads_v10_services_remarketing_action_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v10_services_remarketing_action_service_proto_rawDescData = file_google_ads_googleads_v10_services_remarketing_action_service_proto_rawDesc
)

func file_google_ads_googleads_v10_services_remarketing_action_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v10_services_remarketing_action_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v10_services_remarketing_action_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v10_services_remarketing_action_service_proto_rawDescData)
	})
	return file_google_ads_googleads_v10_services_remarketing_action_service_proto_rawDescData
}

var file_google_ads_googleads_v10_services_remarketing_action_service_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_google_ads_googleads_v10_services_remarketing_action_service_proto_goTypes = []interface{}{
	(*MutateRemarketingActionsRequest)(nil),  // 0: google.ads.googleads.v10.services.MutateRemarketingActionsRequest
	(*RemarketingActionOperation)(nil),       // 1: google.ads.googleads.v10.services.RemarketingActionOperation
	(*MutateRemarketingActionsResponse)(nil), // 2: google.ads.googleads.v10.services.MutateRemarketingActionsResponse
	(*MutateRemarketingActionResult)(nil),    // 3: google.ads.googleads.v10.services.MutateRemarketingActionResult
	(*fieldmaskpb.FieldMask)(nil),            // 4: google.protobuf.FieldMask
	(*resources.RemarketingAction)(nil),      // 5: google.ads.googleads.v10.resources.RemarketingAction
	(*status.Status)(nil),                    // 6: google.rpc.Status
}
var file_google_ads_googleads_v10_services_remarketing_action_service_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v10.services.MutateRemarketingActionsRequest.operations:type_name -> google.ads.googleads.v10.services.RemarketingActionOperation
	4, // 1: google.ads.googleads.v10.services.RemarketingActionOperation.update_mask:type_name -> google.protobuf.FieldMask
	5, // 2: google.ads.googleads.v10.services.RemarketingActionOperation.create:type_name -> google.ads.googleads.v10.resources.RemarketingAction
	5, // 3: google.ads.googleads.v10.services.RemarketingActionOperation.update:type_name -> google.ads.googleads.v10.resources.RemarketingAction
	6, // 4: google.ads.googleads.v10.services.MutateRemarketingActionsResponse.partial_failure_error:type_name -> google.rpc.Status
	3, // 5: google.ads.googleads.v10.services.MutateRemarketingActionsResponse.results:type_name -> google.ads.googleads.v10.services.MutateRemarketingActionResult
	0, // 6: google.ads.googleads.v10.services.RemarketingActionService.MutateRemarketingActions:input_type -> google.ads.googleads.v10.services.MutateRemarketingActionsRequest
	2, // 7: google.ads.googleads.v10.services.RemarketingActionService.MutateRemarketingActions:output_type -> google.ads.googleads.v10.services.MutateRemarketingActionsResponse
...
func init() { file_google_ads_googleads_v10_services_remarketing_action_service_proto_init() }
func file_google_ads_googleads_v10_services_remarketing_action_service_proto_init() {
	if File_google_ads_googleads_v10_services_remarketing_action_service_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v10_services_remarketing_action_service_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v10_services_remarketing_action_service_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v10_services_remarketing_action_service_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v10_services_remarketing_action_service_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
	...
	file_google_ads_googleads_v10_services_remarketing_action_service_proto_msgTypes[1].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v10_services_remarketing_action_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v10_services_remarketing_action_service_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v10_services_remarketing_action_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v10_services_remarketing_action_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v10_services_remarketing_action_service_proto = out.File
	file_google_ads_googleads_v10_services_remarketing_action_service_proto_rawDesc = nil
	file_google_ads_googleads_v10_services_remarketing_action_service_proto_goTypes = nil
	file_google_ads_googleads_v10_services_remarketing_action_service_proto_depIdxs = nil
}
