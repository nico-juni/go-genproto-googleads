...
func (x *MutateFeedItemTargetsRequest) Reset() {
	*x = MutateFeedItemTargetsRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v10_services_feed_item_target_service_proto_msgTypes[0]
...
func (*MutateFeedItemTargetsRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v10_services_feed_item_target_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *FeedItemTargetOperation) Reset() {
	*x = FeedItemTargetOperation{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v10_services_feed_item_target_service_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*FeedItemTargetOperation) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v10_services_feed_item_target_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *MutateFeedItemTargetsResponse) Reset() {
	*x = MutateFeedItemTargetsResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v10_services_feed_item_target_service_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateFeedItemTargetsResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v10_services_feed_item_target_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *MutateFeedItemTargetResult) Reset() {
	*x = MutateFeedItemTargetResult{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v10_services_feed_item_target_service_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateFeedItemTargetResult) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v10_services_feed_item_target_service_proto_rawDescGZIP(), []int{3}
}
...
var file_google_ads_googleads_v10_services_feed_item_target_service_proto_rawDesc = []byte{
...
var (
	file_google_ads_googleads_v10_services_feed_item_target_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v10_services_feed_item_target_service_proto_rawDescData = file_google_ads_googleads_v10_services_feed_item_target_service_proto_rawDesc
)

func file_google_ads_googleads_v10_services_feed_item_target_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v10_services_feed_item_target_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v10_services_feed_item_target_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v10_services_feed_item_target_service_proto_rawDescData)
	})
	return file_google_ads_googleads_v10_services_feed_item_target_service_proto_rawDescData
}

var file_google_ads_googleads_v10_services_feed_item_target_service_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_google_ads_googleads_v10_services_feed_item_target_service_proto_goTypes = []interface{}{
	(*MutateFeedItemTargetsRequest)(nil),                   // 0: google.ads.googleads.v10.services.MutateFeedItemTargetsRequest
	(*FeedItemTargetOperation)(nil),                        // 1: google.ads.googleads.v10.services.FeedItemTargetOperation
	(*MutateFeedItemTargetsResponse)(nil),                  // 2: google.ads.googleads.v10.services.MutateFeedItemTargetsResponse
	(*MutateFeedItemTargetResult)(nil),                     // 3: google.ads.googleads.v10.services.MutateFeedItemTargetResult
	...
	(*resources.FeedItemTarget)(nil),                       // 5: google.ads.googleads.v10.resources.FeedItemTarget
	(*status.Status)(nil),                                  // 6: google.rpc.Status
}
var file_google_ads_googleads_v10_services_feed_item_target_service_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v10.services.MutateFeedItemTargetsRequest.operations:type_name -> google.ads.googleads.v10.services.FeedItemTargetOperation
	4, // 1: google.ads.googleads.v10.services.MutateFeedItemTargetsRequest.response_content_type:type_name -> google.ads.googleads.v10.enums.ResponseContentTypeEnum.ResponseContentType
	5, // 2: google.ads.googleads.v10.services.FeedItemTargetOperation.create:type_name -> google.ads.googleads.v10.resources.FeedItemTarget
	6, // 3: google.ads.googleads.v10.services.MutateFeedItemTargetsResponse.partial_failure_error:type_name -> google.rpc.Status
	3, // 4: google.ads.googleads.v10.services.MutateFeedItemTargetsResponse.results:type_name -> google.ads.googleads.v10.services.MutateFeedItemTargetResult
	5, // 5: google.ads.googleads.v10.services.MutateFeedItemTargetResult.feed_item_target:type_name -> google.ads.googleads.v10.resources.FeedItemTarget
	0, // 6: google.ads.googleads.v10.services.FeedItemTargetService.MutateFeedItemTargets:input_type -> google.ads.googleads.v10.services.MutateFeedItemTargetsRequest
	2, // 7: google.ads.googleads.v10.services.FeedItemTargetService.MutateFeedItemTargets:output_type -> google.ads.googleads.v10.services.MutateFeedItemTargetsResponse
...
func init() { file_google_ads_googleads_v10_services_feed_item_target_service_proto_init() }
func file_google_ads_googleads_v10_services_feed_item_target_service_proto_init() {
	if File_google_ads_googleads_v10_services_feed_item_target_service_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v10_services_feed_item_target_service_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v10_services_feed_item_target_service_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v10_services_feed_item_target_service_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v10_services_feed_item_target_service_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
	...
	file_google_ads_googleads_v10_services_feed_item_target_service_proto_msgTypes[1].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v10_services_feed_item_target_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v10_services_feed_item_target_service_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v10_services_feed_item_target_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v10_services_feed_item_target_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v10_services_feed_item_target_service_proto = out.File
	file_google_ads_googleads_v10_services_feed_item_target_service_proto_rawDesc = nil
	file_google_ads_googleads_v10_services_feed_item_target_service_proto_goTypes = nil
	file_google_ads_googleads_v10_services_feed_item_target_service_proto_depIdxs = nil
}
...
func (c *feedItemTargetServiceClient) MutateFeedItemTargets(ctx context.Context, in *MutateFeedItemTargetsRequest, opts ...grpc.CallOption) (*MutateFeedItemTargetsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/google.ads.googleads.v10.services.FeedItemTargetService/MutateFeedItemTargets", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _FeedItemTargetService_MutateFeedItemTargets_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/google.ads.googleads.v10.services.FeedItemTargetService/MutateFeedItemTargets",
	}
