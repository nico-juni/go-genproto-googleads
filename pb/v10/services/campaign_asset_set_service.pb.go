...
func (x *MutateCampaignAssetSetsRequest) Reset() {
	*x = MutateCampaignAssetSetsRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v10_services_campaign_asset_set_service_proto_msgTypes[0]
...
func (*MutateCampaignAssetSetsRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v10_services_campaign_asset_set_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *CampaignAssetSetOperation) Reset() {
	*x = CampaignAssetSetOperation{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v10_services_campaign_asset_set_service_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*CampaignAssetSetOperation) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v10_services_campaign_asset_set_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *MutateCampaignAssetSetsResponse) Reset() {
	*x = MutateCampaignAssetSetsResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v10_services_campaign_asset_set_service_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateCampaignAssetSetsResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v10_services_campaign_asset_set_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *MutateCampaignAssetSetResult) Reset() {
	*x = MutateCampaignAssetSetResult{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v10_services_campaign_asset_set_service_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateCampaignAssetSetResult) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v10_services_campaign_asset_set_service_proto_rawDescGZIP(), []int{3}
}
...
var file_google_ads_googleads_v10_services_campaign_asset_set_service_proto_rawDesc = []byte{
	...
	0x30, 0x2f, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2f, 0x72, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65,
	...
	0x2e, 0x76, 0x31, 0x30, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x2e, 0x43, 0x61,
	...
	0xe4, 0x93, 0x02, 0x3c, 0x22, 0x37, 0x2f, 0x76, 0x31, 0x30, 0x2f, 0x63, 0x75, 0x73, 0x74, 0x6f,
	...
	0x30, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x42, 0x1c, 0x43, 0x61, 0x6d, 0x70,
...
var (
	file_google_ads_googleads_v10_services_campaign_asset_set_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v10_services_campaign_asset_set_service_proto_rawDescData = file_google_ads_googleads_v10_services_campaign_asset_set_service_proto_rawDesc
)

func file_google_ads_googleads_v10_services_campaign_asset_set_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v10_services_campaign_asset_set_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v10_services_campaign_asset_set_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v10_services_campaign_asset_set_service_proto_rawDescData)
	})
	return file_google_ads_googleads_v10_services_campaign_asset_set_service_proto_rawDescData
}

var file_google_ads_googleads_v10_services_campaign_asset_set_service_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_google_ads_googleads_v10_services_campaign_asset_set_service_proto_goTypes = []interface{}{
	(*MutateCampaignAssetSetsRequest)(nil),                 // 0: google.ads.googleads.v10.services.MutateCampaignAssetSetsRequest
	(*CampaignAssetSetOperation)(nil),                      // 1: google.ads.googleads.v10.services.CampaignAssetSetOperation
	(*MutateCampaignAssetSetsResponse)(nil),                // 2: google.ads.googleads.v10.services.MutateCampaignAssetSetsResponse
	(*MutateCampaignAssetSetResult)(nil),                   // 3: google.ads.googleads.v10.services.MutateCampaignAssetSetResult
	...
	(*resources.CampaignAssetSet)(nil),                     // 5: google.ads.googleads.v10.resources.CampaignAssetSet
	(*status.Status)(nil),                                  // 6: google.rpc.Status
}
var file_google_ads_googleads_v10_services_campaign_asset_set_service_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v10.services.MutateCampaignAssetSetsRequest.operations:type_name -> google.ads.googleads.v10.services.CampaignAssetSetOperation
	4, // 1: google.ads.googleads.v10.services.MutateCampaignAssetSetsRequest.response_content_type:type_name -> google.ads.googleads.v10.enums.ResponseContentTypeEnum.ResponseContentType
	5, // 2: google.ads.googleads.v10.services.CampaignAssetSetOperation.create:type_name -> google.ads.googleads.v10.resources.CampaignAssetSet
	3, // 3: google.ads.googleads.v10.services.MutateCampaignAssetSetsResponse.results:type_name -> google.ads.googleads.v10.services.MutateCampaignAssetSetResult
	6, // 4: google.ads.googleads.v10.services.MutateCampaignAssetSetsResponse.partial_failure_error:type_name -> google.rpc.Status
	5, // 5: google.ads.googleads.v10.services.MutateCampaignAssetSetResult.campaign_asset_set:type_name -> google.ads.googleads.v10.resources.CampaignAssetSet
	0, // 6: google.ads.googleads.v10.services.CampaignAssetSetService.MutateCampaignAssetSets:input_type -> google.ads.googleads.v10.services.MutateCampaignAssetSetsRequest
	2, // 7: google.ads.googleads.v10.services.CampaignAssetSetService.MutateCampaignAssetSets:output_type -> google.ads.googleads.v10.services.MutateCampaignAssetSetsResponse
...
func init() { file_google_ads_googleads_v10_services_campaign_asset_set_service_proto_init() }
func file_google_ads_googleads_v10_services_campaign_asset_set_service_proto_init() {
	if File_google_ads_googleads_v10_services_campaign_asset_set_service_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v10_services_campaign_asset_set_service_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v10_services_campaign_asset_set_service_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v10_services_campaign_asset_set_service_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v10_services_campaign_asset_set_service_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
	...
	file_google_ads_googleads_v10_services_campaign_asset_set_service_proto_msgTypes[1].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v10_services_campaign_asset_set_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v10_services_campaign_asset_set_service_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v10_services_campaign_asset_set_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v10_services_campaign_asset_set_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v10_services_campaign_asset_set_service_proto = out.File
	file_google_ads_googleads_v10_services_campaign_asset_set_service_proto_rawDesc = nil
	file_google_ads_googleads_v10_services_campaign_asset_set_service_proto_goTypes = nil
	file_google_ads_googleads_v10_services_campaign_asset_set_service_proto_depIdxs = nil
}
...
func (c *campaignAssetSetServiceClient) MutateCampaignAssetSets(ctx context.Context, in *MutateCampaignAssetSetsRequest, opts ...grpc.CallOption) (*MutateCampaignAssetSetsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/google.ads.googleads.v10.services.CampaignAssetSetService/MutateCampaignAssetSets", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedCampaignAssetSetServiceServer can be embedded to have forward compatible implementations.
...
func (*UnimplementedCampaignAssetSetServiceServer) MutateCampaignAssetSets(context.Context, *MutateCampaignAssetSetsRequest) (*MutateCampaignAssetSetsResponse, error) {
	return nil, status1.Errorf(codes.Unimplemented, "method MutateCampaignAssetSets not implemented")
}

func RegisterCampaignAssetSetServiceServer(s *grpc.Server, srv CampaignAssetSetServiceServer) {
	s.RegisterService(&_CampaignAssetSetService_serviceDesc, srv)
}
...
func _CampaignAssetSetService_MutateCampaignAssetSets_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/google.ads.googleads.v10.services.CampaignAssetSetService/MutateCampaignAssetSets",
	}
...
var _CampaignAssetSetService_serviceDesc = grpc.ServiceDesc{
