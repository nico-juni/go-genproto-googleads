...
func (x *MutateCustomerFeedsRequest) Reset() {
	*x = MutateCustomerFeedsRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v10_services_customer_feed_service_proto_msgTypes[0]
...
func (*MutateCustomerFeedsRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v10_services_customer_feed_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *CustomerFeedOperation) Reset() {
	*x = CustomerFeedOperation{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v10_services_customer_feed_service_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*CustomerFeedOperation) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v10_services_customer_feed_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *MutateCustomerFeedsResponse) Reset() {
	*x = MutateCustomerFeedsResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v10_services_customer_feed_service_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateCustomerFeedsResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v10_services_customer_feed_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *MutateCustomerFeedResult) Reset() {
	*x = MutateCustomerFeedResult{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v10_services_customer_feed_service_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateCustomerFeedResult) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v10_services_customer_feed_service_proto_rawDescGZIP(), []int{3}
}
...
var file_google_ads_googleads_v10_services_customer_feed_service_proto_rawDesc = []byte{
...
var (
	file_google_ads_googleads_v10_services_customer_feed_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v10_services_customer_feed_service_proto_rawDescData = file_google_ads_googleads_v10_services_customer_feed_service_proto_rawDesc
)

func file_google_ads_googleads_v10_services_customer_feed_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v10_services_customer_feed_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v10_services_customer_feed_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v10_services_customer_feed_service_proto_rawDescData)
	})
	return file_google_ads_googleads_v10_services_customer_feed_service_proto_rawDescData
}

var file_google_ads_googleads_v10_services_customer_feed_service_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_google_ads_googleads_v10_services_customer_feed_service_proto_goTypes = []interface{}{
	(*MutateCustomerFeedsRequest)(nil),                     // 0: google.ads.googleads.v10.services.MutateCustomerFeedsRequest
	(*CustomerFeedOperation)(nil),                          // 1: google.ads.googleads.v10.services.CustomerFeedOperation
	(*MutateCustomerFeedsResponse)(nil),                    // 2: google.ads.googleads.v10.services.MutateCustomerFeedsResponse
	(*MutateCustomerFeedResult)(nil),                       // 3: google.ads.googleads.v10.services.MutateCustomerFeedResult
	...
	(*resources.CustomerFeed)(nil),                         // 6: google.ads.googleads.v10.resources.CustomerFeed
	(*status.Status)(nil),                                  // 7: google.rpc.Status
}
var file_google_ads_googleads_v10_services_customer_feed_service_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v10.services.MutateCustomerFeedsRequest.operations:type_name -> google.ads.googleads.v10.services.CustomerFeedOperation
	4, // 1: google.ads.googleads.v10.services.MutateCustomerFeedsRequest.response_content_type:type_name -> google.ads.googleads.v10.enums.ResponseContentTypeEnum.ResponseContentType
	5, // 2: google.ads.googleads.v10.services.CustomerFeedOperation.update_mask:type_name -> google.protobuf.FieldMask
	6, // 3: google.ads.googleads.v10.services.CustomerFeedOperation.create:type_name -> google.ads.googleads.v10.resources.CustomerFeed
	6, // 4: google.ads.googleads.v10.services.CustomerFeedOperation.update:type_name -> google.ads.googleads.v10.resources.CustomerFeed
	7, // 5: google.ads.googleads.v10.services.MutateCustomerFeedsResponse.partial_failure_error:type_name -> google.rpc.Status
	3, // 6: google.ads.googleads.v10.services.MutateCustomerFeedsResponse.results:type_name -> google.ads.googleads.v10.services.MutateCustomerFeedResult
	6, // 7: google.ads.googleads.v10.services.MutateCustomerFeedResult.customer_feed:type_name -> google.ads.googleads.v10.resources.CustomerFeed
	0, // 8: google.ads.googleads.v10.services.CustomerFeedService.MutateCustomerFeeds:input_type -> google.ads.googleads.v10.services.MutateCustomerFeedsRequest
	2, // 9: google.ads.googleads.v10.services.CustomerFeedService.MutateCustomerFeeds:output_type -> google.ads.googleads.v10.services.MutateCustomerFeedsResponse
...
func init() { file_google_ads_googleads_v10_services_customer_feed_service_proto_init() }
func file_google_ads_googleads_v10_services_customer_feed_service_proto_init() {
	if File_google_ads_googleads_v10_services_customer_feed_service_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v10_services_customer_feed_service_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v10_services_customer_feed_service_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v10_services_customer_feed_service_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v10_services_customer_feed_service_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
	...
	file_google_ads_googleads_v10_services_customer_feed_service_proto_msgTypes[1].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v10_services_customer_feed_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v10_services_customer_feed_service_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v10_services_customer_feed_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v10_services_customer_feed_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v10_services_customer_feed_service_proto = out.File
	file_google_ads_googleads_v10_services_customer_feed_service_proto_rawDesc = nil
	file_google_ads_googleads_v10_services_customer_feed_service_proto_goTypes = nil
	file_google_ads_googleads_v10_services_customer_feed_service_proto_depIdxs = nil
}
...
func (c *customerFeedServiceClient) MutateCustomerFeeds(ctx context.Context, in *MutateCustomerFeedsRequest, opts ...grpc.CallOption) (*MutateCustomerFeedsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/google.ads.googleads.v10.services.CustomerFeedService/MutateCustomerFeeds", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _CustomerFeedService_MutateCustomerFeeds_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/google.ads.googleads.v10.services.CustomerFeedService/MutateCustomerFeeds",
	}
