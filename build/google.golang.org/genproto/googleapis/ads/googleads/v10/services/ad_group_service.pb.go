...
func (x *MutateAdGroupsRequest) Reset() {
	*x = MutateAdGroupsRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v10_services_ad_group_service_proto_msgTypes[0]
...
func (*MutateAdGroupsRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v10_services_ad_group_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *AdGroupOperation) Reset() {
	*x = AdGroupOperation{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v10_services_ad_group_service_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*AdGroupOperation) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v10_services_ad_group_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *MutateAdGroupsResponse) Reset() {
	*x = MutateAdGroupsResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v10_services_ad_group_service_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateAdGroupsResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v10_services_ad_group_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *MutateAdGroupResult) Reset() {
	*x = MutateAdGroupResult{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v10_services_ad_group_service_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateAdGroupResult) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v10_services_ad_group_service_proto_rawDescGZIP(), []int{3}
}
...
var file_google_ads_googleads_v10_services_ad_group_service_proto_rawDesc = []byte{
	...
	0xd3, 0xe4, 0x93, 0x02, 0x33, 0x22, 0x2e, 0x2f, 0x76, 0x31, 0x30, 0x2f, 0x63, 0x75, 0x73, 0x74,
...
var (
	file_google_ads_googleads_v10_services_ad_group_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v10_services_ad_group_service_proto_rawDescData = file_google_ads_googleads_v10_services_ad_group_service_proto_rawDesc
)

func file_google_ads_googleads_v10_services_ad_group_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v10_services_ad_group_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v10_services_ad_group_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v10_services_ad_group_service_proto_rawDescData)
	})
	return file_google_ads_googleads_v10_services_ad_group_service_proto_rawDescData
}

var file_google_ads_googleads_v10_services_ad_group_service_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_google_ads_googleads_v10_services_ad_group_service_proto_goTypes = []interface{}{
	(*MutateAdGroupsRequest)(nil),                          // 0: google.ads.googleads.v10.services.MutateAdGroupsRequest
	(*AdGroupOperation)(nil),                               // 1: google.ads.googleads.v10.services.AdGroupOperation
	(*MutateAdGroupsResponse)(nil),                         // 2: google.ads.googleads.v10.services.MutateAdGroupsResponse
	(*MutateAdGroupResult)(nil),                            // 3: google.ads.googleads.v10.services.MutateAdGroupResult
	...
	(*resources.AdGroup)(nil),                              // 6: google.ads.googleads.v10.resources.AdGroup
	(*status.Status)(nil),                                  // 7: google.rpc.Status
}
var file_google_ads_googleads_v10_services_ad_group_service_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v10.services.MutateAdGroupsRequest.operations:type_name -> google.ads.googleads.v10.services.AdGroupOperation
	4, // 1: google.ads.googleads.v10.services.MutateAdGroupsRequest.response_content_type:type_name -> google.ads.googleads.v10.enums.ResponseContentTypeEnum.ResponseContentType
	5, // 2: google.ads.googleads.v10.services.AdGroupOperation.update_mask:type_name -> google.protobuf.FieldMask
	6, // 3: google.ads.googleads.v10.services.AdGroupOperation.create:type_name -> google.ads.googleads.v10.resources.AdGroup
	6, // 4: google.ads.googleads.v10.services.AdGroupOperation.update:type_name -> google.ads.googleads.v10.resources.AdGroup
	7, // 5: google.ads.googleads.v10.services.MutateAdGroupsResponse.partial_failure_error:type_name -> google.rpc.Status
	3, // 6: google.ads.googleads.v10.services.MutateAdGroupsResponse.results:type_name -> google.ads.googleads.v10.services.MutateAdGroupResult
	6, // 7: google.ads.googleads.v10.services.MutateAdGroupResult.ad_group:type_name -> google.ads.googleads.v10.resources.AdGroup
	0, // 8: google.ads.googleads.v10.services.AdGroupService.MutateAdGroups:input_type -> google.ads.googleads.v10.services.MutateAdGroupsRequest
	2, // 9: google.ads.googleads.v10.services.AdGroupService.MutateAdGroups:output_type -> google.ads.googleads.v10.services.MutateAdGroupsResponse
...
func init() { file_google_ads_googleads_v10_services_ad_group_service_proto_init() }
func file_google_ads_googleads_v10_services_ad_group_service_proto_init() {
	if File_google_ads_googleads_v10_services_ad_group_service_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v10_services_ad_group_service_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v10_services_ad_group_service_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v10_services_ad_group_service_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v10_services_ad_group_service_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
	...
	file_google_ads_googleads_v10_services_ad_group_service_proto_msgTypes[1].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v10_services_ad_group_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v10_services_ad_group_service_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v10_services_ad_group_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v10_services_ad_group_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v10_services_ad_group_service_proto = out.File
	file_google_ads_googleads_v10_services_ad_group_service_proto_rawDesc = nil
	file_google_ads_googleads_v10_services_ad_group_service_proto_goTypes = nil
	file_google_ads_googleads_v10_services_ad_group_service_proto_depIdxs = nil
}
