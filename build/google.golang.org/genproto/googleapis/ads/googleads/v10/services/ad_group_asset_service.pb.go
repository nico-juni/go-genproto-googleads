...
func (x *MutateAdGroupAssetsRequest) Reset() {
	*x = MutateAdGroupAssetsRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v10_services_ad_group_asset_service_proto_msgTypes[0]
...
func (*MutateAdGroupAssetsRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v10_services_ad_group_asset_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *AdGroupAssetOperation) Reset() {
	*x = AdGroupAssetOperation{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v10_services_ad_group_asset_service_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*AdGroupAssetOperation) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v10_services_ad_group_asset_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *MutateAdGroupAssetsResponse) Reset() {
	*x = MutateAdGroupAssetsResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v10_services_ad_group_asset_service_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateAdGroupAssetsResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v10_services_ad_group_asset_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *MutateAdGroupAssetResult) Reset() {
	*x = MutateAdGroupAssetResult{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v10_services_ad_group_asset_service_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateAdGroupAssetResult) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v10_services_ad_group_asset_service_proto_rawDescGZIP(), []int{3}
}
...
var file_google_ads_googleads_v10_services_ad_group_asset_service_proto_rawDesc = []byte{
	...
	0x57, 0x82, 0xd3, 0xe4, 0x93, 0x02, 0x38, 0x22, 0x33, 0x2f, 0x76, 0x31, 0x30, 0x2f, 0x63, 0x75,
...
var (
	file_google_ads_googleads_v10_services_ad_group_asset_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v10_services_ad_group_asset_service_proto_rawDescData = file_google_ads_googleads_v10_services_ad_group_asset_service_proto_rawDesc
)

func file_google_ads_googleads_v10_services_ad_group_asset_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v10_services_ad_group_asset_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v10_services_ad_group_asset_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v10_services_ad_group_asset_service_proto_rawDescData)
	})
	return file_google_ads_googleads_v10_services_ad_group_asset_service_proto_rawDescData
}

var file_google_ads_googleads_v10_services_ad_group_asset_service_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_google_ads_googleads_v10_services_ad_group_asset_service_proto_goTypes = []interface{}{
	(*MutateAdGroupAssetsRequest)(nil),                     // 0: google.ads.googleads.v10.services.MutateAdGroupAssetsRequest
	(*AdGroupAssetOperation)(nil),                          // 1: google.ads.googleads.v10.services.AdGroupAssetOperation
	(*MutateAdGroupAssetsResponse)(nil),                    // 2: google.ads.googleads.v10.services.MutateAdGroupAssetsResponse
	(*MutateAdGroupAssetResult)(nil),                       // 3: google.ads.googleads.v10.services.MutateAdGroupAssetResult
	...
	(*resources.AdGroupAsset)(nil),                         // 6: google.ads.googleads.v10.resources.AdGroupAsset
	(*status.Status)(nil),                                  // 7: google.rpc.Status
}
var file_google_ads_googleads_v10_services_ad_group_asset_service_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v10.services.MutateAdGroupAssetsRequest.operations:type_name -> google.ads.googleads.v10.services.AdGroupAssetOperation
	4, // 1: google.ads.googleads.v10.services.MutateAdGroupAssetsRequest.response_content_type:type_name -> google.ads.googleads.v10.enums.ResponseContentTypeEnum.ResponseContentType
	5, // 2: google.ads.googleads.v10.services.AdGroupAssetOperation.update_mask:type_name -> google.protobuf.FieldMask
	6, // 3: google.ads.googleads.v10.services.AdGroupAssetOperation.create:type_name -> google.ads.googleads.v10.resources.AdGroupAsset
	6, // 4: google.ads.googleads.v10.services.AdGroupAssetOperation.update:type_name -> google.ads.googleads.v10.resources.AdGroupAsset
	7, // 5: google.ads.googleads.v10.services.MutateAdGroupAssetsResponse.partial_failure_error:type_name -> google.rpc.Status
	3, // 6: google.ads.googleads.v10.services.MutateAdGroupAssetsResponse.results:type_name -> google.ads.googleads.v10.services.MutateAdGroupAssetResult
	6, // 7: google.ads.googleads.v10.services.MutateAdGroupAssetResult.ad_group_asset:type_name -> google.ads.googleads.v10.resources.AdGroupAsset
	0, // 8: google.ads.googleads.v10.services.AdGroupAssetService.MutateAdGroupAssets:input_type -> google.ads.googleads.v10.services.MutateAdGroupAssetsRequest
	2, // 9: google.ads.googleads.v10.services.AdGroupAssetService.MutateAdGroupAssets:output_type -> google.ads.googleads.v10.services.MutateAdGroupAssetsResponse
...
func init() { file_google_ads_googleads_v10_services_ad_group_asset_service_proto_init() }
func file_google_ads_googleads_v10_services_ad_group_asset_service_proto_init() {
	if File_google_ads_googleads_v10_services_ad_group_asset_service_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v10_services_ad_group_asset_service_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v10_services_ad_group_asset_service_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v10_services_ad_group_asset_service_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v10_services_ad_group_asset_service_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
	...
	file_google_ads_googleads_v10_services_ad_group_asset_service_proto_msgTypes[1].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v10_services_ad_group_asset_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v10_services_ad_group_asset_service_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v10_services_ad_group_asset_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v10_services_ad_group_asset_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v10_services_ad_group_asset_service_proto = out.File
	file_google_ads_googleads_v10_services_ad_group_asset_service_proto_rawDesc = nil
	file_google_ads_googleads_v10_services_ad_group_asset_service_proto_goTypes = nil
	file_google_ads_googleads_v10_services_ad_group_asset_service_proto_depIdxs = nil
}
