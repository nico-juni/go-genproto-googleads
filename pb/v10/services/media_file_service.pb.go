...
func (x *MutateMediaFilesRequest) Reset() {
	*x = MutateMediaFilesRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v10_services_media_file_service_proto_msgTypes[0]
...
func (*MutateMediaFilesRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v10_services_media_file_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *MediaFileOperation) Reset() {
	*x = MediaFileOperation{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v10_services_media_file_service_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MediaFileOperation) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v10_services_media_file_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *MutateMediaFilesResponse) Reset() {
	*x = MutateMediaFilesResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v10_services_media_file_service_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateMediaFilesResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v10_services_media_file_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *MutateMediaFileResult) Reset() {
	*x = MutateMediaFileResult{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v10_services_media_file_service_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateMediaFileResult) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v10_services_media_file_service_proto_rawDescGZIP(), []int{3}
}
...
var file_google_ads_googleads_v10_services_media_file_service_proto_rawDesc = []byte{
	...
	0x30, 0x2f, 0x76, 0x31, 0x30, 0x2f, 0x63, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x65, 0x72, 0x73, 0x2f,
	...
	0x67, 0x6c, 0x65, 0x2e, 0x61, 0x64, 0x73, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x61, 0x64,
	0x73, 0x2e, 0x76, 0x31, 0x30, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x42, 0x15,
...
var (
	file_google_ads_googleads_v10_services_media_file_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v10_services_media_file_service_proto_rawDescData = file_google_ads_googleads_v10_services_media_file_service_proto_rawDesc
)

func file_google_ads_googleads_v10_services_media_file_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v10_services_media_file_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v10_services_media_file_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v10_services_media_file_service_proto_rawDescData)
	})
	return file_google_ads_googleads_v10_services_media_file_service_proto_rawDescData
}

var file_google_ads_googleads_v10_services_media_file_service_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_google_ads_googleads_v10_services_media_file_service_proto_goTypes = []interface{}{
	(*MutateMediaFilesRequest)(nil),                        // 0: google.ads.googleads.v10.services.MutateMediaFilesRequest
	(*MediaFileOperation)(nil),                             // 1: google.ads.googleads.v10.services.MediaFileOperation
	(*MutateMediaFilesResponse)(nil),                       // 2: google.ads.googleads.v10.services.MutateMediaFilesResponse
	(*MutateMediaFileResult)(nil),                          // 3: google.ads.googleads.v10.services.MutateMediaFileResult
	...
	(*resources.MediaFile)(nil),                            // 5: google.ads.googleads.v10.resources.MediaFile
	(*status.Status)(nil),                                  // 6: google.rpc.Status
}
var file_google_ads_googleads_v10_services_media_file_service_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v10.services.MutateMediaFilesRequest.operations:type_name -> google.ads.googleads.v10.services.MediaFileOperation
	4, // 1: google.ads.googleads.v10.services.MutateMediaFilesRequest.response_content_type:type_name -> google.ads.googleads.v10.enums.ResponseContentTypeEnum.ResponseContentType
	5, // 2: google.ads.googleads.v10.services.MediaFileOperation.create:type_name -> google.ads.googleads.v10.resources.MediaFile
	6, // 3: google.ads.googleads.v10.services.MutateMediaFilesResponse.partial_failure_error:type_name -> google.rpc.Status
	3, // 4: google.ads.googleads.v10.services.MutateMediaFilesResponse.results:type_name -> google.ads.googleads.v10.services.MutateMediaFileResult
	5, // 5: google.ads.googleads.v10.services.MutateMediaFileResult.media_file:type_name -> google.ads.googleads.v10.resources.MediaFile
	0, // 6: google.ads.googleads.v10.services.MediaFileService.MutateMediaFiles:input_type -> google.ads.googleads.v10.services.MutateMediaFilesRequest
	2, // 7: google.ads.googleads.v10.services.MediaFileService.MutateMediaFiles:output_type -> google.ads.googleads.v10.services.MutateMediaFilesResponse
...
func init() { file_google_ads_googleads_v10_services_media_file_service_proto_init() }
func file_google_ads_googleads_v10_services_media_file_service_proto_init() {
	if File_google_ads_googleads_v10_services_media_file_service_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v10_services_media_file_service_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v10_services_media_file_service_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v10_services_media_file_service_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v10_services_media_file_service_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
	...
	file_google_ads_googleads_v10_services_media_file_service_proto_msgTypes[1].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v10_services_media_file_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v10_services_media_file_service_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v10_services_media_file_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v10_services_media_file_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v10_services_media_file_service_proto = out.File
	file_google_ads_googleads_v10_services_media_file_service_proto_rawDesc = nil
	file_google_ads_googleads_v10_services_media_file_service_proto_goTypes = nil
	file_google_ads_googleads_v10_services_media_file_service_proto_depIdxs = nil
}
