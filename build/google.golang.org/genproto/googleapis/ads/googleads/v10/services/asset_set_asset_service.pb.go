...
func (x *MutateAssetSetAssetsRequest) Reset() {
	*x = MutateAssetSetAssetsRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v10_services_asset_set_asset_service_proto_msgTypes[0]
...
func (*MutateAssetSetAssetsRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v10_services_asset_set_asset_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *AssetSetAssetOperation) Reset() {
	*x = AssetSetAssetOperation{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v10_services_asset_set_asset_service_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*AssetSetAssetOperation) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v10_services_asset_set_asset_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *MutateAssetSetAssetsResponse) Reset() {
	*x = MutateAssetSetAssetsResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v10_services_asset_set_asset_service_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateAssetSetAssetsResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v10_services_asset_set_asset_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *MutateAssetSetAssetResult) Reset() {
	*x = MutateAssetSetAssetResult{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v10_services_asset_set_asset_service_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateAssetSetAssetResult) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v10_services_asset_set_asset_service_proto_rawDescGZIP(), []int{3}
}
...
var file_google_ads_googleads_v10_services_asset_set_asset_service_proto_rawDesc = []byte{
	...
	0x30, 0x2e, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x2e, 0x41, 0x73, 0x73, 0x65,
...
var (
	file_google_ads_googleads_v10_services_asset_set_asset_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v10_services_asset_set_asset_service_proto_rawDescData = file_google_ads_googleads_v10_services_asset_set_asset_service_proto_rawDesc
)

func file_google_ads_googleads_v10_services_asset_set_asset_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v10_services_asset_set_asset_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v10_services_asset_set_asset_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v10_services_asset_set_asset_service_proto_rawDescData)
	})
	return file_google_ads_googleads_v10_services_asset_set_asset_service_proto_rawDescData
}

var file_google_ads_googleads_v10_services_asset_set_asset_service_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_google_ads_googleads_v10_services_asset_set_asset_service_proto_goTypes = []interface{}{
	(*MutateAssetSetAssetsRequest)(nil),                    // 0: google.ads.googleads.v10.services.MutateAssetSetAssetsRequest
	(*AssetSetAssetOperation)(nil),                         // 1: google.ads.googleads.v10.services.AssetSetAssetOperation
	(*MutateAssetSetAssetsResponse)(nil),                   // 2: google.ads.googleads.v10.services.MutateAssetSetAssetsResponse
	(*MutateAssetSetAssetResult)(nil),                      // 3: google.ads.googleads.v10.services.MutateAssetSetAssetResult
	...
	(*resources.AssetSetAsset)(nil),                        // 5: google.ads.googleads.v10.resources.AssetSetAsset
	(*status.Status)(nil),                                  // 6: google.rpc.Status
}
var file_google_ads_googleads_v10_services_asset_set_asset_service_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v10.services.MutateAssetSetAssetsRequest.operations:type_name -> google.ads.googleads.v10.services.AssetSetAssetOperation
	4, // 1: google.ads.googleads.v10.services.MutateAssetSetAssetsRequest.response_content_type:type_name -> google.ads.googleads.v10.enums.ResponseContentTypeEnum.ResponseContentType
	5, // 2: google.ads.googleads.v10.services.AssetSetAssetOperation.create:type_name -> google.ads.googleads.v10.resources.AssetSetAsset
	3, // 3: google.ads.googleads.v10.services.MutateAssetSetAssetsResponse.results:type_name -> google.ads.googleads.v10.services.MutateAssetSetAssetResult
	6, // 4: google.ads.googleads.v10.services.MutateAssetSetAssetsResponse.partial_failure_error:type_name -> google.rpc.Status
	5, // 5: google.ads.googleads.v10.services.MutateAssetSetAssetResult.asset_set_asset:type_name -> google.ads.googleads.v10.resources.AssetSetAsset
	0, // 6: google.ads.googleads.v10.services.AssetSetAssetService.MutateAssetSetAssets:input_type -> google.ads.googleads.v10.services.MutateAssetSetAssetsRequest
	2, // 7: google.ads.googleads.v10.services.AssetSetAssetService.MutateAssetSetAssets:output_type -> google.ads.googleads.v10.services.MutateAssetSetAssetsResponse
...
func init() { file_google_ads_googleads_v10_services_asset_set_asset_service_proto_init() }
func file_google_ads_googleads_v10_services_asset_set_asset_service_proto_init() {
	if File_google_ads_googleads_v10_services_asset_set_asset_service_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v10_services_asset_set_asset_service_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v10_services_asset_set_asset_service_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v10_services_asset_set_asset_service_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v10_services_asset_set_asset_service_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
	...
	file_google_ads_googleads_v10_services_asset_set_asset_service_proto_msgTypes[1].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v10_services_asset_set_asset_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v10_services_asset_set_asset_service_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v10_services_asset_set_asset_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v10_services_asset_set_asset_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v10_services_asset_set_asset_service_proto = out.File
	file_google_ads_googleads_v10_services_asset_set_asset_service_proto_rawDesc = nil
	file_google_ads_googleads_v10_services_asset_set_asset_service_proto_goTypes = nil
	file_google_ads_googleads_v10_services_asset_set_asset_service_proto_depIdxs = nil
}
...
func (c *assetSetAssetServiceClient) MutateAssetSetAssets(ctx context.Context, in *MutateAssetSetAssetsRequest, opts ...grpc.CallOption) (*MutateAssetSetAssetsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/google.ads.googleads.v10.services.AssetSetAssetService/MutateAssetSetAssets", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _AssetSetAssetService_MutateAssetSetAssets_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/google.ads.googleads.v10.services.AssetSetAssetService/MutateAssetSetAssets",
	}
