...
func (x *MutateExtensionFeedItemsRequest) Reset() {
	*x = MutateExtensionFeedItemsRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v10_services_extension_feed_item_service_proto_msgTypes[0]
...
func (*MutateExtensionFeedItemsRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v10_services_extension_feed_item_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *ExtensionFeedItemOperation) Reset() {
	*x = ExtensionFeedItemOperation{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v10_services_extension_feed_item_service_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ExtensionFeedItemOperation) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v10_services_extension_feed_item_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *MutateExtensionFeedItemsResponse) Reset() {
	*x = MutateExtensionFeedItemsResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v10_services_extension_feed_item_service_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateExtensionFeedItemsResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v10_services_extension_feed_item_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *MutateExtensionFeedItemResult) Reset() {
	*x = MutateExtensionFeedItemResult{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v10_services_extension_feed_item_service_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateExtensionFeedItemResult) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v10_services_extension_feed_item_service_proto_rawDescGZIP(), []int{3}
}
...
var file_google_ads_googleads_v10_services_extension_feed_item_service_proto_rawDesc = []byte{
	...
	0x2e, 0x76, 0x31, 0x30, 0x2e, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x2e, 0x45,
	...
	0x6c, 0x65, 0x2e, 0x61, 0x64, 0x73, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x61, 0x64, 0x73,
	0x2e, 0x76, 0x31, 0x30, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x42, 0x1d, 0x45,
	0x78, 0x74, 0x65, 0x6e, 0x73, 0x69, 0x6f, 0x6e, 0x46, 0x65, 0x65, 0x64, 0x49, 0x74, 0x65, 0x6d,
...
var (
	file_google_ads_googleads_v10_services_extension_feed_item_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v10_services_extension_feed_item_service_proto_rawDescData = file_google_ads_googleads_v10_services_extension_feed_item_service_proto_rawDesc
)

func file_google_ads_googleads_v10_services_extension_feed_item_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v10_services_extension_feed_item_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v10_services_extension_feed_item_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v10_services_extension_feed_item_service_proto_rawDescData)
	})
	return file_google_ads_googleads_v10_services_extension_feed_item_service_proto_rawDescData
}

var file_google_ads_googleads_v10_services_extension_feed_item_service_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_google_ads_googleads_v10_services_extension_feed_item_service_proto_goTypes = []interface{}{
	(*MutateExtensionFeedItemsRequest)(nil),                // 0: google.ads.googleads.v10.services.MutateExtensionFeedItemsRequest
	(*ExtensionFeedItemOperation)(nil),                     // 1: google.ads.googleads.v10.services.ExtensionFeedItemOperation
	(*MutateExtensionFeedItemsResponse)(nil),               // 2: google.ads.googleads.v10.services.MutateExtensionFeedItemsResponse
	(*MutateExtensionFeedItemResult)(nil),                  // 3: google.ads.googleads.v10.services.MutateExtensionFeedItemResult
	...
	(*resources.ExtensionFeedItem)(nil),                    // 6: google.ads.googleads.v10.resources.ExtensionFeedItem
	(*status.Status)(nil),                                  // 7: google.rpc.Status
}
var file_google_ads_googleads_v10_services_extension_feed_item_service_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v10.services.MutateExtensionFeedItemsRequest.operations:type_name -> google.ads.googleads.v10.services.ExtensionFeedItemOperation
	4, // 1: google.ads.googleads.v10.services.MutateExtensionFeedItemsRequest.response_content_type:type_name -> google.ads.googleads.v10.enums.ResponseContentTypeEnum.ResponseContentType
	5, // 2: google.ads.googleads.v10.services.ExtensionFeedItemOperation.update_mask:type_name -> google.protobuf.FieldMask
	6, // 3: google.ads.googleads.v10.services.ExtensionFeedItemOperation.create:type_name -> google.ads.googleads.v10.resources.ExtensionFeedItem
	6, // 4: google.ads.googleads.v10.services.ExtensionFeedItemOperation.update:type_name -> google.ads.googleads.v10.resources.ExtensionFeedItem
	7, // 5: google.ads.googleads.v10.services.MutateExtensionFeedItemsResponse.partial_failure_error:type_name -> google.rpc.Status
	3, // 6: google.ads.googleads.v10.services.MutateExtensionFeedItemsResponse.results:type_name -> google.ads.googleads.v10.services.MutateExtensionFeedItemResult
	6, // 7: google.ads.googleads.v10.services.MutateExtensionFeedItemResult.extension_feed_item:type_name -> google.ads.googleads.v10.resources.ExtensionFeedItem
	0, // 8: google.ads.googleads.v10.services.ExtensionFeedItemService.MutateExtensionFeedItems:input_type -> google.ads.googleads.v10.services.MutateExtensionFeedItemsRequest
	2, // 9: google.ads.googleads.v10.services.ExtensionFeedItemService.MutateExtensionFeedItems:output_type -> google.ads.googleads.v10.services.MutateExtensionFeedItemsResponse
...
func init() { file_google_ads_googleads_v10_services_extension_feed_item_service_proto_init() }
func file_google_ads_googleads_v10_services_extension_feed_item_service_proto_init() {
	if File_google_ads_googleads_v10_services_extension_feed_item_service_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v10_services_extension_feed_item_service_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v10_services_extension_feed_item_service_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v10_services_extension_feed_item_service_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v10_services_extension_feed_item_service_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
	...
	file_google_ads_googleads_v10_services_extension_feed_item_service_proto_msgTypes[1].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v10_services_extension_feed_item_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v10_services_extension_feed_item_service_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v10_services_extension_feed_item_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v10_services_extension_feed_item_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v10_services_extension_feed_item_service_proto = out.File
	file_google_ads_googleads_v10_services_extension_feed_item_service_proto_rawDesc = nil
	file_google_ads_googleads_v10_services_extension_feed_item_service_proto_goTypes = nil
	file_google_ads_googleads_v10_services_extension_feed_item_service_proto_depIdxs = nil
}
