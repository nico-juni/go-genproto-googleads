...
func (x *MutateCustomerManagerLinkRequest) Reset() {
	*x = MutateCustomerManagerLinkRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v10_services_customer_manager_link_service_proto_msgTypes[0]
...
func (*MutateCustomerManagerLinkRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v10_services_customer_manager_link_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *MoveManagerLinkRequest) Reset() {
	*x = MoveManagerLinkRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v10_services_customer_manager_link_service_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MoveManagerLinkRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v10_services_customer_manager_link_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *CustomerManagerLinkOperation) Reset() {
	*x = CustomerManagerLinkOperation{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v10_services_customer_manager_link_service_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*CustomerManagerLinkOperation) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v10_services_customer_manager_link_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *MutateCustomerManagerLinkResponse) Reset() {
	*x = MutateCustomerManagerLinkResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v10_services_customer_manager_link_service_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateCustomerManagerLinkResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v10_services_customer_manager_link_service_proto_rawDescGZIP(), []int{3}
}
...
func (x *MoveManagerLinkResponse) Reset() {
	*x = MoveManagerLinkResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v10_services_customer_manager_link_service_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MoveManagerLinkResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v10_services_customer_manager_link_service_proto_rawDescGZIP(), []int{4}
}
...
func (x *MutateCustomerManagerLinkResult) Reset() {
	*x = MutateCustomerManagerLinkResult{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v10_services_customer_manager_link_service_proto_msgTypes[5]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateCustomerManagerLinkResult) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v10_services_customer_manager_link_service_proto_rawDescGZIP(), []int{5}
}
...
var file_google_ads_googleads_v10_services_customer_manager_link_service_proto_rawDesc = []byte{
	...
	0x31, 0x30, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x2e, 0x4d, 0x6f, 0x76, 0x65,
	...
	0x01, 0x82, 0xd3, 0xe4, 0x93, 0x02, 0x48, 0x22, 0x43, 0x2f, 0x76, 0x31, 0x30, 0x2f, 0x63, 0x75,
...
var (
	file_google_ads_googleads_v10_services_customer_manager_link_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v10_services_customer_manager_link_service_proto_rawDescData = file_google_ads_googleads_v10_services_customer_manager_link_service_proto_rawDesc
)

func file_google_ads_googleads_v10_services_customer_manager_link_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v10_services_customer_manager_link_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v10_services_customer_manager_link_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v10_services_customer_manager_link_service_proto_rawDescData)
	})
	return file_google_ads_googleads_v10_services_customer_manager_link_service_proto_rawDescData
}

var file_google_ads_googleads_v10_services_customer_manager_link_service_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_google_ads_googleads_v10_services_customer_manager_link_service_proto_goTypes = []interface{}{
	(*MutateCustomerManagerLinkRequest)(nil),  // 0: google.ads.googleads.v10.services.MutateCustomerManagerLinkRequest
	(*MoveManagerLinkRequest)(nil),            // 1: google.ads.googleads.v10.services.MoveManagerLinkRequest
	(*CustomerManagerLinkOperation)(nil),      // 2: google.ads.googleads.v10.services.CustomerManagerLinkOperation
	(*MutateCustomerManagerLinkResponse)(nil), // 3: google.ads.googleads.v10.services.MutateCustomerManagerLinkResponse
	(*MoveManagerLinkResponse)(nil),           // 4: google.ads.googleads.v10.services.MoveManagerLinkResponse
	(*MutateCustomerManagerLinkResult)(nil),   // 5: google.ads.googleads.v10.services.MutateCustomerManagerLinkResult
	(*fieldmaskpb.FieldMask)(nil),             // 6: google.protobuf.FieldMask
	(*resources.CustomerManagerLink)(nil),     // 7: google.ads.googleads.v10.resources.CustomerManagerLink
}
var file_google_ads_googleads_v10_services_customer_manager_link_service_proto_depIdxs = []int32{
	2, // 0: google.ads.googleads.v10.services.MutateCustomerManagerLinkRequest.operations:type_name -> google.ads.googleads.v10.services.CustomerManagerLinkOperation
	6, // 1: google.ads.googleads.v10.services.CustomerManagerLinkOperation.update_mask:type_name -> google.protobuf.FieldMask
	7, // 2: google.ads.googleads.v10.services.CustomerManagerLinkOperation.update:type_name -> google.ads.googleads.v10.resources.CustomerManagerLink
	5, // 3: google.ads.googleads.v10.services.MutateCustomerManagerLinkResponse.results:type_name -> google.ads.googleads.v10.services.MutateCustomerManagerLinkResult
	0, // 4: google.ads.googleads.v10.services.CustomerManagerLinkService.MutateCustomerManagerLink:input_type -> google.ads.googleads.v10.services.MutateCustomerManagerLinkRequest
	1, // 5: google.ads.googleads.v10.services.CustomerManagerLinkService.MoveManagerLink:input_type -> google.ads.googleads.v10.services.MoveManagerLinkRequest
	3, // 6: google.ads.googleads.v10.services.CustomerManagerLinkService.MutateCustomerManagerLink:output_type -> google.ads.googleads.v10.services.MutateCustomerManagerLinkResponse
	4, // 7: google.ads.googleads.v10.services.CustomerManagerLinkService.MoveManagerLink:output_type -> google.ads.googleads.v10.services.MoveManagerLinkResponse
...
func init() { file_google_ads_googleads_v10_services_customer_manager_link_service_proto_init() }
func file_google_ads_googleads_v10_services_customer_manager_link_service_proto_init() {
	if File_google_ads_googleads_v10_services_customer_manager_link_service_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v10_services_customer_manager_link_service_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v10_services_customer_manager_link_service_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v10_services_customer_manager_link_service_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v10_services_customer_manager_link_service_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v10_services_customer_manager_link_service_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v10_services_customer_manager_link_service_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
	...
	file_google_ads_googleads_v10_services_customer_manager_link_service_proto_msgTypes[2].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v10_services_customer_manager_link_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v10_services_customer_manager_link_service_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v10_services_customer_manager_link_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v10_services_customer_manager_link_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v10_services_customer_manager_link_service_proto = out.File
	file_google_ads_googleads_v10_services_customer_manager_link_service_proto_rawDesc = nil
	file_google_ads_googleads_v10_services_customer_manager_link_service_proto_goTypes = nil
	file_google_ads_googleads_v10_services_customer_manager_link_service_proto_depIdxs = nil
}
