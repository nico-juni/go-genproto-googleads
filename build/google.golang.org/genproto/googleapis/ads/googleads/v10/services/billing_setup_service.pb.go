...
func (x *MutateBillingSetupRequest) Reset() {
	*x = MutateBillingSetupRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v10_services_billing_setup_service_proto_msgTypes[0]
...
func (*MutateBillingSetupRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v10_services_billing_setup_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *BillingSetupOperation) Reset() {
	*x = BillingSetupOperation{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v10_services_billing_setup_service_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*BillingSetupOperation) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v10_services_billing_setup_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *MutateBillingSetupResponse) Reset() {
	*x = MutateBillingSetupResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v10_services_billing_setup_service_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateBillingSetupResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v10_services_billing_setup_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *MutateBillingSetupResult) Reset() {
	*x = MutateBillingSetupResult{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v10_services_billing_setup_service_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateBillingSetupResult) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v10_services_billing_setup_service_proto_rawDescGZIP(), []int{3}
}
...
var file_google_ads_googleads_v10_services_billing_setup_service_proto_rawDesc = []byte{
	...
	0x65, 0x2e, 0x61, 0x64, 0x73, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x61, 0x64, 0x73, 0x2e,
	0x76, 0x31, 0x30, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x42, 0x18, 0x42, 0x69,
...
var (
	file_google_ads_googleads_v10_services_billing_setup_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v10_services_billing_setup_service_proto_rawDescData = file_google_ads_googleads_v10_services_billing_setup_service_proto_rawDesc
)

func file_google_ads_googleads_v10_services_billing_setup_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v10_services_billing_setup_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v10_services_billing_setup_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v10_services_billing_setup_service_proto_rawDescData)
	})
	return file_google_ads_googleads_v10_services_billing_setup_service_proto_rawDescData
}

var file_google_ads_googleads_v10_services_billing_setup_service_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_google_ads_googleads_v10_services_billing_setup_service_proto_goTypes = []interface{}{
	(*MutateBillingSetupRequest)(nil),  // 0: google.ads.googleads.v10.services.MutateBillingSetupRequest
	(*BillingSetupOperation)(nil),      // 1: google.ads.googleads.v10.services.BillingSetupOperation
	(*MutateBillingSetupResponse)(nil), // 2: google.ads.googleads.v10.services.MutateBillingSetupResponse
	(*MutateBillingSetupResult)(nil),   // 3: google.ads.googleads.v10.services.MutateBillingSetupResult
	(*resources.BillingSetup)(nil),     // 4: google.ads.googleads.v10.resources.BillingSetup
}
var file_google_ads_googleads_v10_services_billing_setup_service_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v10.services.MutateBillingSetupRequest.operation:type_name -> google.ads.googleads.v10.services.BillingSetupOperation
	4, // 1: google.ads.googleads.v10.services.BillingSetupOperation.create:type_name -> google.ads.googleads.v10.resources.BillingSetup
	3, // 2: google.ads.googleads.v10.services.MutateBillingSetupResponse.result:type_name -> google.ads.googleads.v10.services.MutateBillingSetupResult
	0, // 3: google.ads.googleads.v10.services.BillingSetupService.MutateBillingSetup:input_type -> google.ads.googleads.v10.services.MutateBillingSetupRequest
	2, // 4: google.ads.googleads.v10.services.BillingSetupService.MutateBillingSetup:output_type -> google.ads.googleads.v10.services.MutateBillingSetupResponse
...
func init() { file_google_ads_googleads_v10_services_billing_setup_service_proto_init() }
func file_google_ads_googleads_v10_services_billing_setup_service_proto_init() {
	if File_google_ads_googleads_v10_services_billing_setup_service_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v10_services_billing_setup_service_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v10_services_billing_setup_service_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v10_services_billing_setup_service_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v10_services_billing_setup_service_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
	...
	file_google_ads_googleads_v10_services_billing_setup_service_proto_msgTypes[1].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v10_services_billing_setup_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v10_services_billing_setup_service_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v10_services_billing_setup_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v10_services_billing_setup_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v10_services_billing_setup_service_proto = out.File
	file_google_ads_googleads_v10_services_billing_setup_service_proto_rawDesc = nil
	file_google_ads_googleads_v10_services_billing_setup_service_proto_goTypes = nil
	file_google_ads_googleads_v10_services_billing_setup_service_proto_depIdxs = nil
}
