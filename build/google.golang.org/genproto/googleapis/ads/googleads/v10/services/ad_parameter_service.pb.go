...
func (x *MutateAdParametersRequest) Reset() {
	*x = MutateAdParametersRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v10_services_ad_parameter_service_proto_msgTypes[0]
...
func (*MutateAdParametersRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v10_services_ad_parameter_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *AdParameterOperation) Reset() {
	*x = AdParameterOperation{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v10_services_ad_parameter_service_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*AdParameterOperation) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v10_services_ad_parameter_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *MutateAdParametersResponse) Reset() {
	*x = MutateAdParametersResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v10_services_ad_parameter_service_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateAdParametersResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v10_services_ad_parameter_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *MutateAdParameterResult) Reset() {
	*x = MutateAdParameterResult{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v10_services_ad_parameter_service_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateAdParameterResult) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v10_services_ad_parameter_service_proto_rawDescGZIP(), []int{3}
}
...
var file_google_ads_googleads_v10_services_ad_parameter_service_proto_rawDesc = []byte{
	...
	0x37, 0x22, 0x32, 0x2f, 0x76, 0x31, 0x30, 0x2f, 0x63, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x65, 0x72,
...
var (
	file_google_ads_googleads_v10_services_ad_parameter_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v10_services_ad_parameter_service_proto_rawDescData = file_google_ads_googleads_v10_services_ad_parameter_service_proto_rawDesc
)

func file_google_ads_googleads_v10_services_ad_parameter_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v10_services_ad_parameter_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v10_services_ad_parameter_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v10_services_ad_parameter_service_proto_rawDescData)
	})
	return file_google_ads_googleads_v10_services_ad_parameter_service_proto_rawDescData
}

var file_google_ads_googleads_v10_services_ad_parameter_service_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_google_ads_googleads_v10_services_ad_parameter_service_proto_goTypes = []interface{}{
	(*MutateAdParametersRequest)(nil),                      // 0: google.ads.googleads.v10.services.MutateAdParametersRequest
	(*AdParameterOperation)(nil),                           // 1: google.ads.googleads.v10.services.AdParameterOperation
	(*MutateAdParametersResponse)(nil),                     // 2: google.ads.googleads.v10.services.MutateAdParametersResponse
	(*MutateAdParameterResult)(nil),                        // 3: google.ads.googleads.v10.services.MutateAdParameterResult
	...
	(*resources.AdParameter)(nil),                          // 6: google.ads.googleads.v10.resources.AdParameter
	(*status.Status)(nil),                                  // 7: google.rpc.Status
}
var file_google_ads_googleads_v10_services_ad_parameter_service_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v10.services.MutateAdParametersRequest.operations:type_name -> google.ads.googleads.v10.services.AdParameterOperation
	4, // 1: google.ads.googleads.v10.services.MutateAdParametersRequest.response_content_type:type_name -> google.ads.googleads.v10.enums.ResponseContentTypeEnum.ResponseContentType
	5, // 2: google.ads.googleads.v10.services.AdParameterOperation.update_mask:type_name -> google.protobuf.FieldMask
	6, // 3: google.ads.googleads.v10.services.AdParameterOperation.create:type_name -> google.ads.googleads.v10.resources.AdParameter
	6, // 4: google.ads.googleads.v10.services.AdParameterOperation.update:type_name -> google.ads.googleads.v10.resources.AdParameter
	7, // 5: google.ads.googleads.v10.services.MutateAdParametersResponse.partial_failure_error:type_name -> google.rpc.Status
	3, // 6: google.ads.googleads.v10.services.MutateAdParametersResponse.results:type_name -> google.ads.googleads.v10.services.MutateAdParameterResult
	6, // 7: google.ads.googleads.v10.services.MutateAdParameterResult.ad_parameter:type_name -> google.ads.googleads.v10.resources.AdParameter
	0, // 8: google.ads.googleads.v10.services.AdParameterService.MutateAdParameters:input_type -> google.ads.googleads.v10.services.MutateAdParametersRequest
	2, // 9: google.ads.googleads.v10.services.AdParameterService.MutateAdParameters:output_type -> google.ads.googleads.v10.services.MutateAdParametersResponse
...
func init() { file_google_ads_googleads_v10_services_ad_parameter_service_proto_init() }
func file_google_ads_googleads_v10_services_ad_parameter_service_proto_init() {
	if File_google_ads_googleads_v10_services_ad_parameter_service_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v10_services_ad_parameter_service_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v10_services_ad_parameter_service_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v10_services_ad_parameter_service_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v10_services_ad_parameter_service_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
	...
	file_google_ads_googleads_v10_services_ad_parameter_service_proto_msgTypes[1].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v10_services_ad_parameter_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v10_services_ad_parameter_service_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v10_services_ad_parameter_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v10_services_ad_parameter_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v10_services_ad_parameter_service_proto = out.File
	file_google_ads_googleads_v10_services_ad_parameter_service_proto_rawDesc = nil
	file_google_ads_googleads_v10_services_ad_parameter_service_proto_goTypes = nil
	file_google_ads_googleads_v10_services_ad_parameter_service_proto_depIdxs = nil
}
